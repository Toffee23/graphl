...
// import 'package:vmodel/src/features/settings/views/my_network/my_network.dart';
...
//                       GoRoute(
//                           path: 'notifications',
//                           name: VMCNotifications.route,
//                           builder:
//                               (BuildContext context, GoRouterState state) =>
//                                   VMCNotifications(showAppBar: true)),
//                       // GoRoute(
//                       //   path: 'details/:param',
//                       //   builder: (BuildContext context, GoRouterState state) =>
//                       //       DetailsScreen(
