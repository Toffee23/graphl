...
class VWidgetsCustomisablePopUp extends StatelessWidget {
  ...
  const VWidgetsCustomisablePopUp(
      {required this.popupTitle, required this.popupDescription, required this.onPressed1, required this.onPressed2, required this.option1, required this.option2, super.key});
