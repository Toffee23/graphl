...
class _MyPopupState extends ConsumerState<MyPopup> with SingleTickerProviderStateMixin {
                ...
                child: Column(
                  ...
                  children: [
                            ...
                            Positioned(
                              ...
                              child: notiBadge.Badge(
                                  ...
                                  badgeContent: Text(
                                    ...
                                    '$percentState%',
                                    style: Theme.of(context).textTheme.displayLarge!.copyWith(color: VmodelColors.primaryColor, fontWeight: FontWeight.w600, fontSize: 15.sp),
                                  ),
                                  child: Container()),
                            ),
                          ]),
                        ...
                        Flexible(
                          ...
                          text: TextSpan(
                            ...
                            children: <TextSpan>[
                              ...
                              TextSpan(
                                text: 'of your profile to get access to bookings.',
                                style: Theme.of(context).textTheme.displayMedium!.copyWith(
                                      fontSize: 10.sp,
                                      color: Theme.of(context).primaryColor,
                                      fontWeight: FontWeight.w400,
                    ...
                    VWidgetsDescriptionTextFieldWithTitle(
                      ...
                      validator: (newValue) => VValidatorsMixin.isNotEmpty(newValue, field: 'Bio'),
                      onChanged: (value) {
                        _calculatePercentageComplete();
                      },
                    ...
                    VWidgetsPrimaryTextFieldWithTitle(
                      ...
                      onChanged: (val) {
                        // progressController!.forward();
                        final isValid = _heightFieldState.currentState?.validate();
                        // if (isValid) {
                        _calculatePercentageComplete();
                        // }
                      },
                      keyboardType: TextInputType.number,
                      validator: (value) => VValidatorsMixin.isHeightValid(value, isRequired: true),
                      label: "Height (cm)",
                    ...
                    VWidgetsPrimaryTextFieldWithTitle(
                      ...
                      isIncreaseHeightForErrorText: true,
                      heightForErrorText: 8.h,
                      validator: (value) => VValidatorsMixin.isNotEmpty(value, field: 'Hair colour'),
                    ...
                    VWidgetsPrimaryTextFieldWithTitle(
                      ...
                      isIncreaseHeightForErrorText: true,
                      heightForErrorText: 8.h,
                      validator: (value) => VValidatorsMixin.isNotEmpty(value, field: 'Eye colour'),
                        ...
                        onPressed: () async {
                          if (_formKey.currentState!.validate()) {
                            ...
                            await ref.read(appUserProvider.notifier).updateProfile(
                                  ...
                                  height: HeightModel(value: _heightController.text.trim(), unit: 'cm'),
                            ...
                            //     );
                            VLoader.changeLoadingState(false);
                            ref.read(popUpEnabledProvider.notifier).state = false;
                            // navigateToRoute(context, DashBoardView());
                          } else {
                            VWidgetShowResponse.showToast(
                              ResponseEnum.failed,
                              message: 'Please provide valid input for all fields',
                            );
                          }
                        }),
                  ],
