...
class DiscardDialog extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _AnalyticsColorDailogState();
}
                    ...
                    children: [
                      Expanded(
                        child: Text(
                          ...
                          style: Theme.of(context).textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.w600, fontSize: 10.sp),
                        ),
                      ),
