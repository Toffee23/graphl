...
class EthnicityFieldDropdown extends ConsumerStatefulWidget {
  final String title;
  Ethnicity value;
  // var purpose;
  // var options;
  ...
  @override
  ConsumerState<EthnicityFieldDropdown> createState() =>
      _GenderFieldDropdownState();
}

class _GenderFieldDropdownState extends ConsumerState<EthnicityFieldDropdown> {
  var dropdownIdentifyValue = "";
                  ...
                  return VWidgetsTextButton(
                    ...
                    onPressed: () async {
                      ...
                      await ref
                          ...
                          .updateProfile(ethnicity: widget.value);
