...
class _TwoFieldDropdownState extends ConsumerState<TwoFieldDropdown> {
  ...
  void initState() {
    ...
    // _eyeController.text = authState?.eyes ?? '';
    _selectedTraits = authState?.trait;
    _selectedEthnicity = authState?.ethnicity;
  ...
  Widget build(BuildContext context) {
    ...
    // _selectedEthnicity = user?.ethnicity; //-----This was affecting the state change we have to rehandle it.
                        ...
                        children: [
                          Flexible(
                            child: VWidgetsDropDownTextField(
                              fieldLabel: "Traits",
                              hintText: _selectedTraits == null
                                  ? 'select ...'
                                  : '',
                              value: _selectedTraits,
                              isExpanded: true,
                              onChanged: (val) {
                                setState(() {
                  ...
                  builder: (context, value, child) {
                    return VWidgetsPrimaryButton(
                      ...
                      onPressed: () async {
                        ...
                        await update(isFormValid: formStateKey.currentState!.validate());
