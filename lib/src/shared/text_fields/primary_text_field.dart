        ...
        children: [
          ...
          SizedBox(
            ...
            child: TextFormField(
              ...
              autofocus: autofocus!,
              focusNode: focusNode,
              cursorHeight: disableCursor ? null : 11,
              autocorrect: false,
              ...
              inputFormatters: formatters ?? [FilteringTextInputFormatter.singleLineFormatter],
...
InputDecoration _inputDecoration(
  ...
  return InputDecoration(
      ...
      hintText: hintText,
      helperText: helperText,
      hintStyle: hintStyle ?? Theme.of(context).textTheme.displayMedium!.copyWith(color: Theme.of(context).primaryColor.withOpacity(0.5), fontSize: 12.sp, height: 1.7),
      ...
      focusedBorder: OutlineInputBorder(
          borderSide: BorderSide(
              ...
              width: 2),
          borderRadius: const BorderRadius.all(Radius.circular(8))),
      disabledBorder: OutlineInputBorder(borderSide: BorderSide(color: Theme.of(context).primaryColor.withOpacity(0.4), width: 1.5), borderRadius: const BorderRadius.all(Radius.circular(7.5))),
      border: OutlineInputBorder(borderSide: BorderSide(color: Theme.of(context).primaryColor, width: 1.5), borderRadius: const BorderRadius.all(Radius.circular(7.5))),
      enabledBorder: OutlineInputBorder(borderSide: BorderSide(color: Theme.of(context).primaryColor, width: 1), borderRadius: const BorderRadius.all(Radius.circular(7.5))),
