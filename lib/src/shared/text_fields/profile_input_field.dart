...
class _ProfileInputFieldState extends ConsumerState<ProfileInputField> {
  ...
  void initState() {
    ...
    ref.read(discardProvider.notifier).initialState('${widget.title.replaceAll(' ', '-')}', initial: widget.value, current: widget.value);
    super.initState();
  }
                  ...
                  children: [
                    ...
                    widget.isBio
                        ? VWidgetsDescriptionTextFieldWithTitle(
                            ...
                            labelStyle: Theme.of(context).textTheme.displayMedium!.copyWith(fontSize: 14, fontWeight: FontWeight.w600, color: VmodelColors.mainColor),
                            hintStyle: Theme.of(context).textTheme.displayMedium!.copyWith(fontSize: 14, fontWeight: FontWeight.w500, color: VmodelColors.mainColor),
                            onChanged: (val) {
                              ref.read(discardProvider.notifier).updateState('${widget.title.replaceAll(' ', '-')}', newValue: val);
                            },
                            // controller: ,
                          )
                    ...
                    if (widget.title == 'Username') ...[
                      ...
                      Container(
                        ...
                        child: Row(children: [
                          ...
                          SizedBox(
                            width: 75.w,
                            child: Text('Note: After a successful update you will be logged out for security reasons. Please sign in again with your new username',
...
class PhoneAndEmailInputField extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PhoneAndEmailInputField> createState() => _PhoneAndEmailInputFieldState();
}

class _PhoneAndEmailInputFieldState extends ConsumerState<PhoneAndEmailInputField> {
  final TextEditingController textController = TextEditingController();
  bool isEdited = false;
  ...
  void initState() {
    if (widget.phoneData != null) {
      _countryCode = widget.phoneData!.countryCode.isEmptyOrNull ? _countryCode : widget.phoneData!.countryCode;
                    ...
                    children: [
                      VWidgetsCountryPhoneFieldWithTitle(
                        ...
                        onCountryChanged: (value) {
                          ...
                          _intlNumber = '+${value.dialCode}${textController.text.trim()}';
                    ...
                    return VWidgetsPrimaryButton(
                      ...
                      onPressed: () async {
                        ...
                        if (widget.onPhoneSave != null) {
                          final temp = PhoneNumberModel(number: textController.text.trim(), countryCode: _countryCode, e164Number: _intlNumber);
                        ...
                        // VLoader.changeLoadingState(false);
                        showLoading.value = false;
                        !isEdited ? goBack(context) : context.push('/VerifyNewPhone');
                      },
                      enableButton: true,
                    );
                  }),
