...
class ProfileDropdownInput extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ProfileDropdownInput> createState() => _ProfileDropdownInputState();
}
...
class _ProfileDropdownInputState extends ConsumerState<ProfileDropdownInput> {
  ...
  initState() {
    super.initState();
    if (widget.yearsOfExperience != null) _yearsOfExperienceController.text = widget.yearsOfExperience.toString();
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(
              ...
              child: Row(
                children: [
                  if (widget.title.toLowerCase() != "Experience Level".toLowerCase()) ...[
                    Expanded(
                      child: VWidgetsDropdownNormal(
                        fieldLabel: widget.title.toLowerCase() == "Experience Level".toLowerCase() ? "Profile Label" : null,
                  ...
                  if (widget.title.toLowerCase() == "Experience Level".toLowerCase())
                    Expanded(
                      child: VWidgetsTextFieldNormal(
                        ...
                        hintText: valueOrNull(_yearsOfExperienceController.text) ?? "Ex. 2",
                ...
                builder: (context, value, _) {
                  return VWidgetsPrimaryButton(
                    ...
                    onPressed: () async {
                      ...
                      isLoading.value = true;
                      if (widget.title.toLowerCase() == "Experience Level".toLowerCase()) {
                        await updateYearsOfExperience(_yearsOfExperienceController.text);
                      }
  ...
  Future<void> updateYearsOfExperience(String value) async {
    ...
    await ref.read(appUserProvider.notifier).updateProfile(yearsOfExperience: years);
  }
