...
class VWidgetsDatePickerUI extends StatefulWidget {
  ...
  const VWidgetsDatePickerUI({super.key, this.selection, this.startDate, this.endDate});
                ...
                children: [
                  SfDateRangePicker(
                    ...
                    initialSelectedRange: PickerDateRange(
                        widget.startDate ?? DateTime.now().subtract(const Duration(days: 4)), widget.endDate ?? DateTime.now().add(const Duration(days: 3))),
                  ),
                ],
              ),
            ),
