    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (isBio && content.length <= 500)
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 20),
              child: Text("Tip: Users with longer bio's are more likely to get booked than user with shorter ones",
              textAlign:TextAlign.center,
              style: contentStyle ?? Theme.of(context).textTheme.labelSmall?.copyWith(
                color: Colors.grey,
              ),),
            ),
          // addVerticalSpacing(16),
