...
// import '../features/authentication/login/views/auth_widget.dart';
...
import '../features/settings/views/booking_settings/views/availability_view.dart';
...
import '../features/splash/views/new_splash.dart';
...
final _othersNavigatorKey = GlobalKey<NavigatorState>(debugLabel: 'others');
...
GoRouter router = GoRouter(
    ...
    routes: <RouteBase>[
      ...
      GoRoute(
        path: '/',
        builder: (context, state) => NewSplash(),
        pageBuilder: (context, state) => CupertinoPage(child: NewSplash()),
      ),
      GoRoute(
      ...
      StatefulShellRoute.indexedStack(
          ...
          branches: <StatefulShellBranch>[
            ...
            StatefulShellBranch(
                ...
                routes: <RouteBase>[
                  ...
                  GoRoute(
                    ...
                    pageBuilder: (context, state) =>
                        CupertinoPage(child: CreateLiveClass()),
                  ),
                  GoRoute(
                  ...
                  GoRoute(
                      ...
                      routes: [
                        GoRoute(
                          ...
                          builder: (context, state) =>
                              BusinessMyJobsPageMarketplace(),
                          pageBuilder: (context, state) => CupertinoPage(
                              child: BusinessMyJobsPageMarketplace()),
                        ),
                        ...
                        GoRoute(
                          ...
                          builder: (context, state) => ViewAllScreen(
                              title:
                                  state.pathParameters['title'] ?? 'Spotlight'),
                          pageBuilder: (context, state) => CupertinoPage(
                              child: ViewAllScreen(
                                  title: state.pathParameters['title'] ??
                                      'Spotlight')),
                        ...
                        GoRoute(
                          ...
                          builder: (context, state) {
                            return AllJobs(
                              title:
                                  state.pathParameters['title'] ?? 'All jobs',
                            );
                          },
                          pageBuilder: (context, state) => CupertinoPage(
                              child: AllJobs(
                        ...
                        GoRoute(
                          ...
                          builder: (context, state) => CategoryServices(
                              title: state.pathParameters['title']!),
                          pageBuilder: (context, state) => CupertinoPage(
                            child: CategoryServices(
                                title: state.pathParameters['title']!),
                          ),
                        ),
                        ...
                        GoRoute(
                          ...
                          pageBuilder: (context, state) => CupertinoPage(
                              child: JobBookerApplicationsHomepage()),
                        ),
                        GoRoute(
                          path: Routes.createJobFirstPage,
                          builder: (context, state) {
                            return CreateJobFirstPage(
                              isEdit: state.pathParameters['isEdit'] ==
                                          "false" ||
                          ...
                          builder: (context, state) {
                            return CreateJobSecondPage(
                              isEdit: state.pathParameters['isEdit'] ==
                                  ...
                                  : true,
                              jobType:
                                  state.pathParameters['jobType'] ?? 'Remote',
                            );
                          },
                          pageBuilder: (context, state) => CupertinoPage(
                        ...
                        // GoRoute(
                        //   path: 'sub_all_jobs',
                        //   builder: (context, state) => SubAllJobs(
                        //     jobs: data,
                        ...
                        GoRoute(
                            ...
                            pageBuilder: (context, state) => CupertinoPage(
                                child: MarketPlaceServicesTabPage()),
                            routes: []),
                        GoRoute(
                        ...
                        GoRoute(
                          ...
                          builder: (context, state) => ServicePackageDetail(
                            ...
                            isCurrentUser:
                                state.pathParameters['isCurrentUser'] ==
                                            "false" ||
                                        state.pathParameters['isCurrentUser'] ==
                                            false
                                    ? false
                        ...
                        GoRoute(
                          ...
                          builder: (context, state) {
                            return ViewAllServicesHomepage(
                              ...
                              title: state.pathParameters['title'] ??
                                  'Discounted services',
                              isRecommended: state.pathParameters[
                                              'isRecommended'] ==
                                          "false" ||
                                      state.pathParameters['isRecommended'] ==
                                          false
                                  ? false
                                  : true,
                              isDiscounted: state
                                              .pathParameters['isDiscounted'] ==
                                          "false" ||
                                      state.pathParameters['isDiscounted'] ==
                                          false
                                  ? false
                                  : true,
                            );
                        ...
                        GoRoute(
                          path: 'allJobsSearch/:enableLargeTile',
                          builder: (context, state) => AllJobsSearch(
                            enableLargeTile:
                                state.pathParameters['enableLargeTile'] ==
                                        'true'
                                    ? true
                                    : false,
                          ),
                        ...
                        GoRoute(
                          ...
                          builder: (context, state) =>
                              JobMarketFilterBottomSheet(),
                          pageBuilder: (context, state) => CupertinoPage(
                              child: JobMarketFilterBottomSheet()),
                        ),
                        GoRoute(
                        ...
                        GoRoute(
                          ...
                          pageBuilder: (context, state) =>
                              CupertinoPage(child: JobDetails()),
                        ),
                      ]),
                ]),
            //Profile
            StatefulShellBranch(
                ...
                routes: <RouteBase>[
                  GoRoute(
                      ...
                      builder: (context, state) => ProfileBaseScreen(
                            isCurrentUser:
                                state.pathParameters['isCurrentUser'] == 'true'
                                    ? true
                                    : false,
                          ),
                      pageBuilder: (context, state) => CupertinoPage(
                      ...
                      routes: [
                        ...
                        GoRoute(
                          ...
                          builder: (context, state) => VWidgetsLocalBusinessProfileButtons(
                              bookNowOnPressed: json.decode(
                                  state.pathParameters['bookNowOnPressed']!),
                              topPicksOnPressed: json.decode(
                                  state.pathParameters['topPicksOnPressed']!),
                              messagesOnPressed: json.decode(
                                  state.pathParameters['messagesOnPressed']!),
                              onNetworkPressed: json.decode(
                                  state.pathParameters['onNetworkPressed']!),
                              socialAccoutsOnPressed: json.decode(state
                                  .pathParameters['socialAccoutsOnPressed']!),
                              socialAccoutsLongPressed: json.decode(
                                  state.pathParameters[
                                      'socialAccoutsLongPressed']!)),
                          pageBuilder: (context, state) => CupertinoPage(
                              child: VWidgetsLocalBusinessProfileButtons(
                                  bookNowOnPressed: json.decode(state
                                      .pathParameters['bookNowOnPressed']!),
                                  topPicksOnPressed: json.decode(state
                                      .pathParameters['topPicksOnPressed']!),
                                  messagesOnPressed: json.decode(state
                                      .pathParameters['messagesOnPressed']!),
                                  onNetworkPressed: json.decode(state
                                      .pathParameters['onNetworkPressed']!),
                                  socialAccoutsOnPressed: json.decode(
                                      state.pathParameters[
                        ...
                        GoRoute(
                          ...
                          builder: (context, state) => NewPostPolaroidView(
                            shouldHaveBackButton:
                                state.pathParameters['shouldHaveBackButton'] ==
                                        'true'
                                    ? true
                                    : false,
                          ),
                        ...
                        GoRoute(
                          ...
                          builder: (context, state) => HelpDetailsViewTwo(
                            tutorialDetailsDescription: state
                                .pathParameters['tutorialDetailsDescription'],
                        ...
                        GoRoute(
                          path:
                              'portfolio-gallery-settings/:title/:galleryType',
                          builder: (context, state) =>
                          ...
                          pageBuilder: (context, state) => CupertinoPage(
                            child: PortfolioGalleriesSettingsHomepage(
                              title: state.pathParameters['title'] ?? "",
                              galleryType:
                                  state.pathParameters['galleryType'] ==
                                          AlbumType.portfolio.name
                                      ? AlbumType.portfolio
                                      : AlbumType.polaroid,
                            ),
                        ...
                        GoRoute(
                          ...
                          builder: (context, state) =>
                              VWidgetsBookingSettingsCard(
                                  title: json
                                      .decode(state.pathParameters['title']!),
                                  onTap: json
                                      .decode(state.pathParameters['onTap']!)),
                          pageBuilder: (context, state) => CupertinoPage(
                        ...
                        GoRoute(
                          ...
                          builder: (context, state) =>
                              BookingCheckoutPaymentView(),
                          pageBuilder: (context, state) => CupertinoPage(
                              child: BookingCheckoutPaymentView()),
                        ),
                        GoRoute(
                          path:
                          ...
                          builder: (context, state) => CreateBookingFirstPage(
                            username: state.pathParameters['username'] ?? '',
                            displayName:
                                state.pathParameters['displayName'] ?? '',
                            serviceId: state.pathParameters['serviceId'] ?? '',
                            unavailableDates: DateClass()
                                .listOfStringToListOfDate(json.decode(
                          ...
                          pageBuilder: (context, state) => CupertinoPage(
                            child: CreateBookingFirstPage(
                              ...
                              unavailableDates: DateClass()
                                  .listOfStringToListOfDate(json.decode(state
                                          .pathParameters['unavailableDates'] ??
                                      '')),
                            ),
                          ),
                        ),
                        ...
                        GoRoute(
                          ...
                          pageBuilder: (context, state) => CupertinoPage(
                              child: ReferAndEarnInviteContactsPage()),
                        ),
                        ...
                        GoRoute(
                          ...
                          pageBuilder: (context, state) => CupertinoPage(
                              child: ShortcutsAndTricksHomepage()),
                        ),
                        GoRoute(
                          path: 'help_home',
                        ...
                        GoRoute(
                          ...
                          pageBuilder: (context, state) => CupertinoPage(
                              child: VMCNotifications(
                                  showAppBar:
                                      state.pathParameters['showAppBar'] ==
                                              "false"
                                          ? false
                                          : true)),
                        ),
                        ...
                        GoRoute(
                          ...
                          pageBuilder: (context, state) => CupertinoPage(
                              child: ReviewsUI(
                                  ...
                                  username:
                                      state.pathParameters['username'] ?? '',
                                  profilePictureUrl: (state.pathParameters[
                                              'profilePictureUrl'] ??
                                          "")
                                      .replaceAll('****', ''),
                                  thumbnailUrl:
                        ...
                        GoRoute(
                          ...
                          builder: (context, state) => GotoIndexFeed(
                            ...
                            navigationDepth: int.parse(
                                state.pathParameters['navigationDepth']!),
                          ),
                          pageBuilder: (context, state) => CupertinoPage(
                              child: GotoIndexFeed(
                            data: GalleryModel.fromMap(
                        ...
                        GoRoute(
                          path:
                              'galleryFeedViewHomepage/:galleryId/:galleryName/:username/:profilePictureUrl/:profileThumbnailUrl/:tappedIndex',
                          builder: (context, state) => GalleryFeedViewHomepage(
                          ...
                          pageBuilder: (context, state) => CupertinoPage(
                              child: GalleryFeedViewHomepage(
                                  galleryId: state.pathParameters['galleryId']!,
                                  galleryName:
                                      state.pathParameters['galleryName']!,
                                  username: state.pathParameters['username']!,
                                  profilePictureUrl: state
                                      .pathParameters['profilePictureUrl']!,
                                  profileThumbnailUrl: state
                                      .pathParameters['profileThumbnailUrl']!,
                                  tappedIndex: int.parse(
                                      state.pathParameters['tappedIndex']!))),
                        ),
                        GoRoute(
                        ...
                        GoRoute(
                          ...
                          pageBuilder: (context, state) =>
                              CupertinoPage(child: CreateOffer()),
                        ),
                        GoRoute(
                        ...
                        GoRoute(
                          path:
                              '/messagesChatScreen/:id/:username/:profilePicture/:profileThumbnailUrl/:label/:messages',
                          parentNavigatorKey: _profileNavigatorKey,
                          builder: (context, state) => MessagesChatScreen(
                            id: int.parse(state.pathParameters['id']!),
                            username: state.pathParameters['username']!,
                            profilePicture:
                                state.pathParameters['profilePicture'],
                            profileThumbnailUrl:
                                state.pathParameters['profileThumbnailUrl'],
                            deep: state.extra == null
                                ? false
                                : (state.extra as bool),
                            label: state.pathParameters['label'],
                            messages: state.pathParameters['messages']
                        ...
                        GoRoute(
                          ...
                          builder: (context, state) =>
                              ReferAndEarnInviteContactPage(
                                  contact: Contact.fromMap(json.decode(
                                      state.pathParameters['contact']!))),
                          pageBuilder: (context, state) => CupertinoPage(
                        ...
                        GoRoute(
                          ...
                          pageBuilder: (context, state) => CupertinoPage(
                              child: VerifiedUsernameWidget(
                                  username: state.pathParameters['username']!,
                                  isVerified:
                                      state.pathParameters['isVerified'] ==
                                              'true'
                                          ? true
                                          : false,
                                  blueTickVerified: state.pathParameters[
                                              'blueTickVerified'] ==
                                          'true'
                                      ? true
                                      : false)),
                        ...
                        GoRoute(
                          ...
                          pageBuilder: (context, state) => CupertinoPage(
                              child: GalleryTabs(
                                  tabs: json
                                      .decode(state.pathParameters['tabs']!))),
                        ),
                        GoRoute(
                          path:
                          ...
                          builder: (context, state) => Gallery(
                              ...
                              userProfilePictureUrl: state
                                  .pathParameters['userProfilePictureUrl']!,
                              ...
                              isSaved: state.pathParameters['isSaved'] == 'true'
                                  ...
                                  : false,
                              photos:
                                  galleryMap(state.pathParameters['photos']!),
                              gallery: GalleryModel.fromMap(json
                                  .decode(state.pathParameters['gallery']!)),
                              hasVideo:
                                  state.pathParameters['hasVideo'] == 'true'
                                      ? true
                                      : false),
                          pageBuilder: (context, state) => CupertinoPage(
                              child: Gallery(
                                  ...
                                  userProfilePictureUrl: state
                                      .pathParameters['userProfilePictureUrl']!,
                                  userProfileThumbnailUrl: state.pathParameters[
                                      'userProfileThumbnailUrl']!,
                                  username: state.pathParameters['username']!,
                                  isSaved:
                                      state.pathParameters['isSaved'] == 'true'
                                          ? true
                                          : false,
                                  photos: galleryMap(
                                      state.pathParameters['photos']!),
                                  gallery: GalleryModel.fromMap(json.decode(
                                      state.pathParameters['gallery']!)),
                                  hasVideo:
                                      state.pathParameters['hasVideo'] == 'true'
                                          ? true
                                          : false)),
                        ...
                        GoRoute(
                          ...
                          builder: (context, state) => VWidgetsProfileBio(
                              extendedbioInfo: json.decode(
                                  state.pathParameters['extendedbioInfo']!),
                              onPressedIcon: json.decode(
                                  state.pathParameters['onPressedIcon']!),
                              mainBioInfo: json
                                  .decode(state.pathParameters['mainBioInfo']!),
                              imgLink:
                                  json.decode(state.pathParameters['imgLink']!),
                          ...
                          pageBuilder: (context, state) => CupertinoPage(
                              child: VWidgetsProfileBio(
                                  ...
                                  onPressedIcon: json.decode(
                                      state.pathParameters['onPressedIcon']!),
                                  mainBioInfo: json.decode(
                                      state.pathParameters['mainBioInfo']!),
                                  imgLink: json
                                      .decode(state.pathParameters['imgLink']!),
                                  key: json
                                      .decode(state.pathParameters['key']!))),
                        ),
                        GoRoute(
                          ...
                          builder: (context, state) =>
                              VWidgetsProfileSubInfoDetails(
                                  stars: json
                                      .decode(state.pathParameters['stars']!),
                                  userName: json.decode(
                                      state.pathParameters['userName']!),
                                  address: json
                                      .decode(state.pathParameters['address']!),
                                  budget: json
                                      .decode(state.pathParameters['budget']!),
                                  companyUrl: json.decode(
                                      state.pathParameters['companyUrl']!),
                                  onPressedCompanyURL: json.decode(state
                                      .pathParameters['onPressedCompanyURL']!)),
                          pageBuilder: (context, state) => CupertinoPage(
                              child: VWidgetsProfileSubInfoDetails(
                                  ...
                                  companyUrl: json.decode(
                                      state.pathParameters['companyUrl']!),
                                  onPressedCompanyURL: json.decode(
                                      state.pathParameters[
                                          'onPressedCompanyURL']!))),
                        ),
                        GoRoute(
                        ...
                        GoRoute(
                          ...
                          builder: (context, state) => VWidgetsOtherBusinessProfileButtons(
                              username: json
                                  .decode(state.pathParameters['username']!),
                              connectionStatus: json.decode(
                                  state.pathParameters['connectionStatus']!),
                              messagesOnPressed: json.decode(
                                  state.pathParameters['messagesOnPressed']!),
                              socialAccountsOnPressed: json.decode(state
                                  .pathParameters['socialAccountsOnPressed']!),
                              servicesOnPressed: json.decode(
                                  state.pathParameters['servicesOnPressed']!),
                              connectOnPressed: json.decode(
                                  state.pathParameters['connectOnPressed']!),
                              removeOnPressed: json.decode(
                                  state.pathParameters['removeOnPressed']!),
                              requestConnectOnPressed: json.decode(state
                                  .pathParameters['requestConnectOnPressed']!),
                              removeRequestOnPressed: json.decode(state.pathParameters['removeRequestOnPressed']!)),
                          pageBuilder: (context, state) => CupertinoPage(
                              child: VWidgetsOtherBusinessProfileButtons(
                                  username: json.decode(
                                      state.pathParameters['username']!),
                                  connectionStatus: json.decode(state
                                      .pathParameters['connectionStatus']!),
                                  messagesOnPressed: json.decode(state
                                      .pathParameters['messagesOnPressed']!),
                                  socialAccountsOnPressed: json.decode(state.pathParameters[
                                      'socialAccountsOnPressed']!),
                                  servicesOnPressed: json.decode(state
                                      .pathParameters['servicesOnPressed']!),
                                  connectOnPressed:
                                      json.decode(state.pathParameters['connectOnPressed']!),
                                  removeOnPressed: json.decode(state.pathParameters['removeOnPressed']!),
                                  requestConnectOnPressed: json.decode(state.pathParameters['requestConnectOnPressed']!),
                                  removeRequestOnPressed: json.decode(state.pathParameters['removeRequestOnPressed']!))),
                        ),
                        GoRoute(
                          path:
                          ...
                          builder: (context, state) =>
                              RemoteBusinessProfileHeaderWidget(
                                  ...
                                  connectionStatus: json.decode(state
                                      .pathParameters['connectionStatus']!),
                                  connectionId: json.decode(state
                                      .pathParameters['connectionStatus']!),
                                  profilePictureUrlThumbnail: json.decode(state
                                      .pathParameters['connectionStatus']!)),
                          pageBuilder: (context, state) => CupertinoPage(
                        ...
                        GoRoute(
                          ...
                          builder: (context, state) =>
                              AccountSettingsLocationPage(),
                          pageBuilder: (context, state) => CupertinoPage(
                              child: AccountSettingsLocationPage()),
                        ),
                        GoRoute(
                          path: 'AccountSettingsNamePage',
                          builder: (context, state) =>
                              AccountSettingsNamePage(),
                          pageBuilder: (context, state) =>
            ...
            //Other
            StatefulShellBranch(
                navigatorKey: _othersNavigatorKey,
                routes: <RouteBase>[
                  GoRoute(
                    path: '/dashboard_ui',
                  ...
                  // GoRoute(
                  //   path: '/webview_widget',
                  //   builder: (context, state) => WebViewWidget(controller: null,),
                  // ),
                  GoRoute(
                    path: '/creation_tool',
                    builder: (context, state) => CreationTools(),
                  ...
                  GoRoute(
                    ...
                    builder: (context, state) => CreatePostWithCameraPicker(
                        cameraImage:
                            File(state.pathParameters['cameraPath'] ?? '')),
                    pageBuilder: (context, state) => CupertinoPage(
                        child: CreatePostWithCameraPicker(
                            cameraImage: File(
                                state.pathParameters['cameraPath'] ?? ''))),
                  ),
                  GoRoute(
                    path: '/createPostWithImagesMediaPicker',
                    builder: (context, state) =>
                        CreatePostWithImagesMediaPicker(),
                    pageBuilder: (context, state) =>
                  ...
                  GoRoute(
                    ...
                    pageBuilder: (context, state) => CupertinoPage(
                        child: EditPostPage(
                            postId: int.parse(state.pathParameters['postId']!),
                            images:
                                json.decode(state.pathParameters['images']!))),
                  ),
                  GoRoute(
                    path: '/uploadVideoPostPage/:videoFile',
                    builder: (context, state) => UploadVideoPostPage(
                        videoFile:
                            json.decode(state.pathParameters['videoFile']!)),
                    pageBuilder: (context, state) => CupertinoPage(
                        child: UploadVideoPostPage(
                            videoFile: json
                                .decode(state.pathParameters['videoFile']!))),
                  ),
                  GoRoute(
                  ...
                  GoRoute(
                    ...
                    pageBuilder: (context, state) =>
                        CupertinoPage(child: MapSearch()),
                  ),
                  GoRoute(
                    path: '/mostViewdAlbum',
                    builder: (context, state) => MostViewdAlbum(),
                    pageBuilder: (context, state) =>
                        CupertinoPage(child: MostViewdAlbum()),
                  ),
                  ...
                  GoRoute(
                    ...
                    pageBuilder: (context, state) =>
                        CupertinoPage(child: VModelMaps()),
                  ),
                  ...
                  GoRoute(
                    ...
                    pageBuilder: (context, state) => CupertinoPage(
                        child: ViewFullVideoPage(
                            state.pathParameters['videoUrl']!)),
                  ),
                  ...
                  GoRoute(
                    ...
                    pageBuilder: (context, state) =>
                        CupertinoPage(child: SplashView()),
                  ),
                  GoRoute(
                    path: '/splitterPage',
                  ...
                  GoRoute(
                    ...
                    pageBuilder: (context, state) => CupertinoPage(
                        child: DisplayBoards(
                            boardWidget: json
                                .decode(state.pathParameters['boardWidget']!))),
                  ),
                  ...
                  GoRoute(
                    ...
                    pageBuilder: (context, state) =>
                        CupertinoPage(child: VWidgetsAppBar()),
                  ),
                  ...
                  GoRoute(
                    ...
                    builder: (context, state) => RenderSvg(
                      ...
                      svgHeight:
                          double.parse(state.pathParameters['svgHeight']!),
                    ...
                    pageBuilder: (context, state) => CupertinoPage(
                      child: RenderSvg(
                        ...
                        svgHeight:
                            double.parse(state.pathParameters['svgHeight']!),
                        svgWidth:
                            double.parse(state.pathParameters['svgWidth']!),
                      ),
                    ),
                  ),
                  ...
                  GoRoute(
                    path:
                        '/textOverlayedImage/:imageUrl/:onTap/:onLongPress/:title',
                    builder: (context, state) => TextOverlayedImage(
                        imageUrl:
                            json.decode(state.pathParameters['imageUrl']!),
                        onTap: json.decode(state.pathParameters['onTap']!),
                        onLongPress:
                            json.decode(state.pathParameters['onLongPress']!),
                    ...
                    pageBuilder: (context, state) => CupertinoPage(
                        child: TextOverlayedImage(
                            ...
                            onTap: json.decode(state.pathParameters['onTap']!),
                            onLongPress: json
                                .decode(state.pathParameters['onLongPress']!),
                            title:
                                json.decode(state.pathParameters['title']!))),
                  ),
                  GoRoute(
                  ...
                  GoRoute(
                    ...
                    builder: (context, state) => VWidgetsInputBottomSheet(
                        controller:
                            json.decode(state.pathParameters['controller']!)),
                    pageBuilder: (context, state) => CupertinoPage(
                        child: VWidgetsInputBottomSheet(
                            controller: json
                                .decode(state.pathParameters['controller']!))),
                  ),
                  GoRoute(
                    path: '/vWidgetsConfirmationWithPictureBottomSheet',
                    builder: (context, state) =>
                        VWidgetsConfirmationWithPictureBottomSheet(
                            username: state.pathParameters['username']!,
                            profilePictureUrl:
                                state.pathParameters['profilePictureUrl']!,
                            profileThumbnailUrl:
                                state.pathParameters['profileThumbnailUrl']!,
                            dialogMessage:
                                state.pathParameters['dialogMessage']!),
                    pageBuilder: (context, state) => CupertinoPage(
                  ...
                  GoRoute(
                    path:
                        '/vWidgetsCategoryButton/:isSelected/:text/:onPressed',
                    builder: (context, state) => VWidgetsCategoryButton(
                        isSelected:
                            json.decode(state.pathParameters['isSelected']!),
                        text: json.decode(state.pathParameters['text']!),
                        onPressed:
                            json.decode(state.pathParameters['onPressed']!)),
                    pageBuilder: (context, state) => CupertinoPage(
                        child: VWidgetsCategoryButton(
                            isSelected: json
                                .decode(state.pathParameters['isSelected']!),
                            text: json.decode(state.pathParameters['text']!),
                            onPressed: json
                                .decode(state.pathParameters['onPressed']!))),
                  ),
                  GoRoute(
                    path: '/vCupertinoActionSheet/:text',
                    builder: (context, state) => VCupertinoActionSheet(
                        text: state.pathParameters['text']!),
                    pageBuilder: (context, state) => CupertinoPage(
                        child: VCupertinoActionSheet(
                            text: state.pathParameters['text']!)),
                  ),
                  ...
                  GoRoute(
                    ...
                    pageBuilder: (context, state) =>
                        CupertinoPage(child: DiscardDialog()),
                  ),
                  ...
                  GoRoute(
                    ...
                    pageBuilder: (context, state) => CupertinoPage(
                        child: HorizontalListViewViewAll(
                            ...
                            onTap: json.decode(state.pathParameters['onTap']!),
                            itemBuilder: json
                                .decode(state.pathParameters['itemBuilder']!),
                  ...
                  GoRoute(
                    path:
                        '/vWidgetsPictureAvataStyle/:imagePath/:imageHeight/:imageWidth',
                    ...
                    pageBuilder: (context, state) => CupertinoPage(
                        child: VWidgetsPictureAvataStyle(
                            imagePath: json.decode(
                                state.pathParameters['separatorBuilder']!),
                            imageHeight: json.decode(
                                state.pathParameters['separatorBuilder']!),
                            imageWidth: json.decode(
                                state.pathParameters['separatorBuilder']!))),
                  ),
                  ...
                  GoRoute(
                    ...
                    builder: (context, state) => RoundedSquareAvatar(
                        ...
                        thumbnail:
                            json.decode(state.pathParameters['thumbnail']!)),
                    pageBuilder: (context, state) => CupertinoPage(
                        child: RoundedSquareAvatar(
                            url: json.decode(state.pathParameters['url']!),
                            thumbnail: json
                                .decode(state.pathParameters['thumbnail']!))),
                  ),
                  ...
                  GoRoute(
                    ...
                    builder: (context, state) => VWidgetsConfirmationPopUp(
                        popupTitle:
                            json.decode(state.pathParameters['popupTitle']!),
                        popupDescription: json
                            .decode(state.pathParameters['popupDescription']!),
                        onPressedYes:
                    ...
                    pageBuilder: (context, state) => CupertinoPage(
                        child: VWidgetsConfirmationPopUp(
                            popupTitle: json
                                .decode(state.pathParameters['popupTitle']!),
                            popupDescription: json.decode(
                                state.pathParameters['popupDescription']!),
                            onPressedYes: json
                                .decode(state.pathParameters['onPressedYes']!),
                            onPressedNo: json
                                .decode(state.pathParameters['onPressedNo']!))),
                  ),
                  ...
                  GoRoute(
                    ...
                    builder: (context, state) => VWidgetsCustomisablePopUp(
                      ...
                      popupDescription: json
                          .decode(state.pathParameters['popupDescription']!),
                      onPressed1:
                          json.decode(state.pathParameters['onPressed1']!),
                      onPressed2:
                          json.decode(state.pathParameters['onPressed2']!),
                  ...
                  GoRoute(
                    path:
                        '/vWidgetsInputPopUp/:popupTitle/:popupField/:onPressedYes',
                    builder: (context, state) => VWidgetsInputPopUp(
                        popupTitle:
                            json.decode(state.pathParameters['popupTitle']!),
                        popupField:
                            json.decode(state.pathParameters['popupField']!),
                        onPressedYes:
                            json.decode(state.pathParameters['onPressedYes']!)),
                    pageBuilder: (context, state) => CupertinoPage(
                        child: VWidgetsInputPopUp(
                            popupTitle: json
                                .decode(state.pathParameters['popupTitle']!),
                            popupField: json
                                .decode(state.pathParameters['popupField']!),
                            onPressedYes: json.decode(
                                state.pathParameters['onPressedYes']!))),
                  ),

                  GoRoute(
                    path: '/vWidgetsPopUpWithoutSaveButton',
                    builder: (context, state) =>
                        VWidgetsPopUpWithoutSaveButton(),
                    pageBuilder: (context, state) =>
                  ...
                  GoRoute(
                    ...
                    builder: (context, state) => VWidgetsRangeSlider(
                        sliderMaxValue: json
                            .decode(state.pathParameters['sliderMaxValue']!),
                        sliderMinValue: json
                            .decode(state.pathParameters['sliderMinValue']!),
                        sliderValue:
                            json.decode(state.pathParameters['sliderValue']!),
                        onChanged:
                            json.decode(state.pathParameters['onChanged']!)),
                    pageBuilder: (context, state) => CupertinoPage(
                        child: VWidgetsRangeSlider(
                            sliderMaxValue: json.decode(
                                state.pathParameters['sliderMaxValue']!),
                            sliderMinValue: json.decode(
                                state.pathParameters['sliderMinValue']!),
                            sliderValue: json
                                .decode(state.pathParameters['sliderValue']!),
                            onChanged: json
                                .decode(state.pathParameters['onChanged']!))),
                  ),
                  ...
                  GoRoute(
                    ...
                    builder: (context, state) => VWidgetsTabs(
                        tabItems:
                            json.decode(state.pathParameters['tabItems']!),
                        containerHeight: json
                            .decode(state.pathParameters['containerHeight']!),
                        containerWidth: json
                            .decode(state.pathParameters['containerWidth']!),
                        tabBarHeight:
                            json.decode(state.pathParameters['tabBarHeight']!),
                        tabViewHeight:
                            json.decode(state.pathParameters['tabViewHeight']!),
                        tabViews:
                            json.decode(state.pathParameters['tabViews']!)),
                    pageBuilder: (context, state) => CupertinoPage(
                        child: VWidgetsTabs(
                            tabItems:
                                json.decode(state.pathParameters['tabItems']!),
                            containerHeight: json.decode(
                                state.pathParameters['containerHeight']!),
                            containerWidth: json.decode(
                                state.pathParameters['containerWidth']!),
                            tabBarHeight: json
                                .decode(state.pathParameters['tabBarHeight']!),
                            tabViewHeight: json
                                .decode(state.pathParameters['tabViewHeight']!),
                            tabViews: json
                                .decode(state.pathParameters['tabViews']!))),
                  ),
                  ...
                  GoRoute(
                    ...
                    builder: (context, state) => VWidgetsCarouselIndicator(
                        ...
                        totalIndicators: json
                            .decode(state.pathParameters['totalIndicators']!)),
                    pageBuilder: (context, state) => CupertinoPage(
                        child: VWidgetsCarouselIndicator(
                            currentIndex: json
                                .decode(state.pathParameters['currentIndex']!),
                            totalIndicators: json.decode(
                                state.pathParameters['totalIndicators']!))),
                  ),
                  ...
                  GoRoute(
                    ...
                    builder: (context, state) => SectionContainer(
                      child: json.decode(state.pathParameters['child']!),
                      topRadius:
                          json.decode(state.pathParameters['topRadius']!),
                      bottomRadius:
                          json.decode(state.pathParameters['bottomRadius']!),
                    ),
                    pageBuilder: (context, state) => CupertinoPage(
                  ...
                  GoRoute(
                    ...
                    pageBuilder: (context, state) =>
                        CupertinoPage(child: CheckOutInfo()),
                  ),
                  ...
                  GoRoute(
                    ...
                    builder: (context, state) => VWidgetsSettingUsersListTile(
                        ...
                        profileImageThumbnail: json.decode(
                            state.pathParameters['profileImageThumbnail']!),
                        subTitle:
                            json.decode(state.pathParameters['subTitle']!),
                        onPressedDelete: json
                            .decode(state.pathParameters['onPressedDelete']!),
                        isVerified:
                            json.decode(state.pathParameters['isVerified']!),
                        blueTickVerified: json
                            .decode(state.pathParameters['blueTickVerified']!)),
                    pageBuilder: (context, state) => CupertinoPage(
                        child: VWidgetsSettingUsersListTile(
                            ...
                            title: json.decode(state.pathParameters['title']!),
                            profileImage: json
                                .decode(state.pathParameters['profileImage']!),
                            profileImageThumbnail: json.decode(
                                state.pathParameters['profileImageThumbnail']!),
                            subTitle:
                                json.decode(state.pathParameters['subTitle']!),
                            onPressedDelete: json.decode(
                                state.pathParameters['onPressedDelete']!),
                            isVerified: json
                                .decode(state.pathParameters['isVerified']!),
                            blueTickVerified: json.decode(
                                state.pathParameters['blueTickVerified']!))),
                  ),
