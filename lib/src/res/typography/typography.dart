...
class VModelTypography1 {
  ...
  static customWidthOpacityText(opacity, fontWeight) =>
      TextStyle(fontFamily: VModelTypography1.primaryfontName, color: VmodelColors.mainColor.withOpacity(opacity), fontSize: 16, fontWeight: fontWeight);
...
class VModelDarkTheme {
  ...
  static TextStyle normalTextStyle = const TextStyle(fontFamily: primaryfontName, fontSize: 15, color: VmodelColors.darkOnPrimaryColor);
  static TextStyle mediumTextStyle = const TextStyle(fontFamily: primaryfontName, fontSize: 15, color: VmodelColors.darkOnPrimaryColor);
  static TextStyle smallTextStyle = const TextStyle(fontFamily: primaryfontName, fontSize: 15, color: VmodelColors.darkOnPrimaryColor);
  static TextStyle bodySmallTextStyle = const TextStyle(fontFamily: primaryfontName, fontSize: 15, color: VmodelColors.darkOnPrimaryColor);
  ...
  static const TextStyle unselectedLabelTextStyle = TextStyle(fontFamily: VModelTypography1.primaryfontName, fontWeight: FontWeight.w400, color: Colors.white);
...
customWidthOpacityText(opacity, fontWeight) => TextStyle(fontFamily: VModelTypography1.primaryfontName, color: VmodelColors.mainColor.withOpacity(opacity), fontSize: 16, fontWeight: fontWeight);
