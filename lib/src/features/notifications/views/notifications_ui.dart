                ...
                child: data.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          final String dateString = datum['createdAt'].toString();
                          final DateTime date = DateTime.parse(dateString);
                          if (index == 0) {
                            isSameDate = false;
                          } else {
                            final String prevDateString = datum['createdAt'].toString();
                            final DateTime prevDate = DateTime.parse(prevDateString);
                            isSameDate = date.isSameDate(prevDate);
                          }

                          final String username = datum['message'].toString().split(" ").first.toLowerCase();

                          final String profilePictureUrl = datum['profilePictureUrl'] ?? '';
                          final String thumbnailUrl = datum['thumbnailUrl'] ?? '';
                            ...
                            return Column(children: [
                              ...
                              GestureDetector(
                                onTap: () {
                                  ...
                                  _showPostIfAny(username: username, profilePictureUrl: profilePictureUrl, postMap: postMap);
                                ...
                                child: VWidgetsNotificationCard(
                                  ...
                                  checkProfilePicture: datum['profilePictureUrl'] == null ? false : true,
                                  date: date.timeAgo(),
                                ),
                              )
                            ]);
