                      ...
                      return Column(
                        children: [
                          ...
                          VWidgetsBusinessMyJobsCard(
                            ...
                            StartTime: data[index].jobDelivery.first.startTime.toString(),
                            EndTime: data[index].jobDelivery.first.endTime.toString(),
                            ...
                            // jobBudget: "450",
                            jobBudget: VConstants.noDecimalCurrencyFormatterGB.format(data[index].priceValue.round()),
                            candidateType: "Female",
                            // navigateToRoute(
                            //     context, JobDetailPage(job: jobs[index]));
                            onItemTap: () {
                              ref.read(singleJobProvider.notifier).state = data[index];
