...
class UserPostBoardRepo {
  ...
  Future<Either<CustomException, Map<String, dynamic>>> createPostBoard(String title) async {
    try {
  ...
  Future<Either<CustomException, Map<String, dynamic>>> savePostToBoard({required int postId, int? boardId}) async {
    try {
      final result = await vBaseServiceInstance.mutationQuery(mutationDocument: '''
  ...
  Future<Either<CustomException, Map<String, dynamic>>> deleteSavedPostFromBoard({required int postId, int? boardId}) async {
    try {
      final result = await vBaseServiceInstance.mutationQuery(mutationDocument: '''
  ...
  Future<Either<CustomException, Map<String, dynamic>>> pinPostBoard({required int boardId}) async {
    try {
      final result = await vBaseServiceInstance.mutationQuery(mutationDocument: '''
  ...
  Future<Either<CustomException, Map<String, dynamic>>> unpinPostBoard({required int boardId}) async {
    try {
      final result = await vBaseServiceInstance.mutationQuery(mutationDocument: '''
  ...
  Future<Either<CustomException, Map<String, dynamic>>> deleteUserBoard({required int boardId}) async {
    try {
      final result = await vBaseServiceInstance.mutationQuery(mutationDocument: '''
  ...
  Future<Either<CustomException, Map<String, dynamic>>> renameUserBoard({required int boardId, required String title}) async {
    try {
      final result = await vBaseServiceInstance.mutationQuery(mutationDocument: '''
  ...
  Future<Either<CustomException, List<dynamic>>> getRecentlyViewedBoards() async {
    try {
      final result = await vBaseServiceInstance.getQuery(queryDocument: '''
  ...
  Future<Either<CustomException, List<dynamic>>> getBoardPosts({required int boardId, required int pageCount, int? pageNumber}) async {
    //print("''''''''''''''''''''''''''''''");
    try {
      final result = await vBaseServiceInstance.getQuery(queryDocument: '''
