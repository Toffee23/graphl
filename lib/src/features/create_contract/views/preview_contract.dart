                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Text(
                                    'Subtotal',
                                    style: VmodelTypography2.kCommentTextStyle.copyWith(color: const Color(0xff666666).withOpacity(0.5)),
                                  ),
                                  Text(
                                    '£155.00',
                                    style: VmodelTypography2.kCommentTextStyle,
                              ...
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text('Grand Total', style: VmodelTypography2.kBoldTextStyle),
                                  Text(
                                    '£450.00',
                                    style: VmodelTypography2.kBoldTextStyle,
                                  ),
                        ...
                        VWidgetsPrimaryButton(
                          ...
                          enableButton: true,
                          buttonHeight: 40,
                          buttonTitleTextStyle: Theme.of(context).textTheme.headlineSmall!.copyWith(color: Colors.white, fontWeight: FontWeight.bold),
                        ),
                      ],
                    ),
                  ),
