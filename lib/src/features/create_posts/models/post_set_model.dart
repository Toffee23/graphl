...
class AlbumPostSetModel {
  ...
  factory AlbumPostSetModel.fromMap(Map<String, dynamic> map) {
    try {
      ...
      final _usersThatLiked = map['usersThatLiked'] ?? [];
      ...
      return AlbumPostSetModel(
        ...
        usersThatLiked: _usersThatLiked,
  ...
  @override
  String toString() {
    return 'AlbumPostSetModel(id: $id, albumId: $albumId, likes: $likes, hasVideo: $hasVideo, userLiked: $userLiked, userSaved: $userSaved, aspectRatio: $aspectRatio, caption: $caption, locationInfo: $locationInfo, user: $user, tagged: $tagged, media: $photos, createdAt: $createdAt, updatedAt: $updatedAt,usersThatLiked: $usersThatLiked, service: $service)';
  }
