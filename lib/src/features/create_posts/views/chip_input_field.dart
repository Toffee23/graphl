...
class VWidgetChipsField extends ConsumerStatefulWidget {
  ...
  final void Function(List<VAppUser>) onChanged;
  ...
  Widget build(BuildContext context) {
    return ChipsInput<VAppUser>(
      ...
      decoration: UIConstants.instance.inputDecoration(
        ...
        suffixIcon: null,
        hintText: '',
        helperText: widget.maxNumberOfChips == null ? null : 'Maximum of ${widget.maxNumberOfChips} mentions',
        hintStyle: null,
        contentPadding: const EdgeInsets.fromLTRB(8, 0, 8, 20),
      ),
      ...
      findSuggestions: (String query) async {
        logger.d('Query sent for suggestion');
      ...
      chipBuilder: (context, state, VAppUser profile) {
        return InputChip(
          ...
          avatar: CircleAvatar(
            ...
            backgroundImage: profile.profilePictureUrl.isHttpOkay ? CachedNetworkImageProvider('${profile.profilePictureUrl}') : null,
          ),
