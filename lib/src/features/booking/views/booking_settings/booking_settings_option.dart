                  ...
                  Row(
                    children: [
                      const Expanded(
                        ...
                        child: Text("Glamour", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 17)),
                      )),
                      IconButton(
                        onPressed: () {
                  ...
                  Row(
                    children: [
                      const Expanded(
                          child: Padding(
                        padding: EdgeInsets.all(14.0),
                        child: Text("Comercial", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 17)),
                      )),
                      IconButton(
                        onPressed: () {
                  ...
                  Row(
                    children: [
                      const Expanded(
                          child: Padding(
                        padding: EdgeInsets.all(14.0),
                        child: Text("Fashion", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 17)),
                      )),
                      IconButton(
                        onPressed: () {
                  ...
                  Row(
                    children: [
                      const Expanded(
                          child: Padding(
                        padding: EdgeInsets.all(14.0),
                        child: Text("Food", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 17)),
                      )),
                      IconButton(
                        onPressed: () {
