              ...
              child: GestureDetector(
                ...
                child: Text(
                  ...
                  style: Theme.of(context).textTheme.displayLarge!.copyWith(
                        color: Theme.of(context).primaryColor.withOpacity(_sliderLeft ? 1 : .5),
              ...
              child: Padding(
                ...
                child: GestureDetector(
                  ...
                  child: Text(
                    "VMC history",
                    style: Theme.of(context).textTheme.displayLarge!.copyWith(
                          color: Theme.of(context).primaryColor.withOpacity(_sliderLeft ? .5 : 1),
                          fontWeight: FontWeight.w600,
                        ),
                  ),
                ),
          ...
          Align(
            ...
            child: Row(
              ...
              children: [
                // if (_sliderLeft)
                Container(
                  color: _sliderLeft ? Theme.of(context).primaryColor : Colors.transparent,
                  height: 1,
