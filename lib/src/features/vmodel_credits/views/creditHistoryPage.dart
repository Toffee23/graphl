        ...
        child: Stack(
          children: [
            ...
            ref.watch(vmcRecordProvider).when(data: (actions) {
              ...
              if (actions.isEmpty) {
                return Center(child: Text("No VMC history, engage to earn credits"));
              }
              return Container(
                    ...
                    children: [
                      Expanded(
                        ...
                        child: ListView.separated(
                          ...
                          shrinkWrap: true,
                          physics: _isRefresh ? NeverScrollableScrollPhysics() : BouncingScrollPhysics(),
                                ...
                                children: [
                                  Flexible(
                                    child: Text(
                                      ...
                                      style: Theme.of(context).textTheme.displayMedium?.copyWith(
                                            fontSize: 14,
                                            color: actions[index].pointsEarned < 0 ? Colors.red : null,
            ...
            Align(
              ...
              child: VWidgetsPrimaryButton(
                onPressed: () => navigateToRoute(context, CreditWithdrawalPage()),
