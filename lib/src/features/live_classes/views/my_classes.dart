...
class MyClassesPage extends ConsumerStatefulWidget {
  static const routeName = 'myClassesPage';
  ...
  @override
  ConsumerState<MyClassesPage> createState() => _LiveClassesPageState();
}

class _LiveClassesPageState extends ConsumerState<MyClassesPage> {
  int _slide = 0;
                      ...
                      return GridView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          return UpcomingClassTile(
                            ...
                            onTap: () {
                              context.push('/live_class_detail', extra: _class);
                            },
                          );
                        },
                      );
