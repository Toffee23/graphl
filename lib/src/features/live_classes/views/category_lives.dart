...
class CategoryLives extends ConsumerStatefulWidget {
  const CategoryLives({
    Key? key,
  ...
  @override
  ConsumerState<CategoryLives> createState() => _LiveClassesPageState();
}

class _LiveClassesPageState extends ConsumerState<CategoryLives> {
  int _slide = 0;
