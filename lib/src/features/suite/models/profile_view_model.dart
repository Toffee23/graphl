...
enum AnalyticLabelType { day, week, month, year }
...
class DailyViewModel {
  ...
  AnalyticLabelType get labelType {
    if (day != null)
      return AnalyticLabelType.day;
    else if (week != null)
      return AnalyticLabelType.week;
    else
      return AnalyticLabelType.month;
  }
