...
class ImageGridSplitterPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _ImageGridSplitterPageState();
}
...
class _ImageGridSplitterPageState extends ConsumerState<ImageGridSplitterPage> {
            ...
            content: Stack(
              ...
              children: <Widget>[
                ClipRRect(
                  ...
                  child: Image.asset(
                    'assets/images/discover_images/Group 1171275245.jpg',
                  ),
                ),
                GestureDetector(
                  onTap: () {
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  BusinessInfoTagWidget(
                                      isSelected: selectedSplit == selectedSplitEnum.oneThree ? true : false,
                                      text: '1x3',
                                      onPressed: () {
                                        splitHeight = 1;
                                        splitWidtht = 3;
                                  ...
                                  BusinessInfoTagWidget(
                                      isSelected: selectedSplit == selectedSplitEnum.twoThree ? true : false,
                                      text: '2x3',
                                      onPressed: () {
                                        splitHeight = 2;
                                        splitWidtht = 3;
                                  ...
                                  BusinessInfoTagWidget(
                                      isSelected: selectedSplit == selectedSplitEnum.threeThree ? true : false,
                                      text: '3x3',
                                      onPressed: () {
                                        splitHeight = 3;
                                        splitWidtht = 3;
                                  ...
                                  BusinessInfoTagWidget(
                                      isSelected: selectedSplit == selectedSplitEnum.fourThree ? true : false,
                                      text: '4x3',
                                      onPressed: () {
                                        splitHeight = 4;
                                        splitWidtht = 3;
                              ...
                              VWidgetsPrimaryButton(
                                ...
                                onPressed: () async {
                                  ...
                                  final data = await CropperMine.crop(cropperKey: cropperKey);

                                  // final imagee = await decodeAsset(image);
                                  final imagee = await decodeAsset('', memImage: data!, isFromMemory: true); // hImage.memory(data!);
                                  if (imagee == null) {
                                    return;
                                  }
                                  final pics = splitImage(imagee, splitHeight, splitWidtht);
                                  setState(() {
                                    _shoeLoading = false;
                                  });
                                  navigateToRoute(
  ...
  Future<img.Image?> decodeAsset(String path, {Uint8List? memImage, bool isFromMemory = false}) async {
    ...
    if (!isFromMemory) {
      ...
      buffer = await ui.ImmutableBuffer.fromUint8List(data.buffer.asUint8List());
    } else {
    ...
    final image = img.Image.fromBytes(width: id.width, height: id.height, bytes: uiBytes!.buffer, numChannels: 4);
