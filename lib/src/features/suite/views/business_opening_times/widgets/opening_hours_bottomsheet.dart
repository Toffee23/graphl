...
class OpeningHoursBottomSheet extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final fadedTextColor = Theme.of(context).textTheme.bodyMedium?.color?.withOpacity(0.5);

    final requestUsername = ref.watch(userNameForApiRequestProvider('$username'));
                                  ...
                                  Flexible(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        OpenNowOrClosedText(isOpen: data.isOpen),
                                        // RichText(
                                        //     text: TextSpan(text: '', children: [
                                        //   TextSpan(
                                        //     text: '${VMString.bullet} ',
                        ...
                        child: Container(
                          ...
                          child: RawScrollbar(
                            ...
                            child: ListView(
                              ...
                              children: List.generate(data.openingTimes.length, (index) {
                                final item = data.openingTimes[index];
                                return _itemTile(
                                  context,
                                  title: item.day,
                                  value: item.allDay ? 'Always open' : '${item.open} - ${item.close}',
                                );
  ...
  Widget _itemTile(BuildContext context, {required String title, required String value}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        SizedBox(
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: Theme.of(context).textTheme.bodyMedium!.copyWith(
                            fontWeight: FontWeight.w400,
                            color: value.toLowerCase() == openText ? Colors.green : null,
                          ),
                    ),
                    // addHorizontalSpacing(8),
