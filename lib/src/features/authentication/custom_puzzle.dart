    ...
    return ConstrainedBox(
      ...
      child: Column(
        ...
        children: [
          Flexible(
            child: ClipRRect(
              borderRadius: widget.borderRadius??BorderRadius.circular(widget.borderImager),
              child: istrue
                  ? SliderCaptCha(
                      image: widget.image,
                      offsetX: _offsetMove,
                      ...
                      child: Container(
                        ...
                        decoration: widget.slideContainerDecoration ??
                            BoxDecoration(
                              ...
                              color: widget.iconContainerColor ?? Colors.white,
                            ),
                        child: widget.icon ??
                            const Icon(
