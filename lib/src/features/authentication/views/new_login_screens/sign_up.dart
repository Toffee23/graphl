                      ...
                      onPressed: () async {
                        ...
                        if (_formKey.currentState!.validate() == false) {
                          Fluttertoast.showToast(
                              msg: "Please fill all the fields", gravity: ToastGravity.TOP, timeInSecForIosWeb: 1, backgroundColor: VmodelColors.error, textColor: Colors.white, fontSize: 16.0);
                        } else {
                          _formKey.currentState?.save();
                          progress?.show();
                          final authNotifier = ref.read(authProvider.notifier);
                          await authNotifier.register(_email.text.toLowerCase().trim(), _password1.text.trim(), _username.text.capitalizeFirst!.trim(), _password2.text.trim(),
