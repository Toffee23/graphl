    ...
    return result.fold((left) {
      ...
      if (success) {
        ...
        await ref
            ...
            .startLoginSession(username, password1, context, isSignUp: true , location: 'register');
        ...
        if (errors.isNotEmpty) {
          for (var key in right['errors'].keys) {
            if (right['errors'][key] != null && right['errors'][key] != "") {
              //print("${right['errors'][key]},$key");
              message = right['errors'][key][0]['message'];
            }
          }
          VWidgetShowResponse.showToast(ResponseEnum.failed, message: message);
        }
      }
