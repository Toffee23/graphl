...
final latLongProvider = AsyncNotifierProvider.family.autoDispose<LatLongNotifier, Position?, BuildContext>(LatLongNotifier.new);

class LatLongNotifier extends AutoDisposeFamilyAsyncNotifier<Position?, BuildContext> {
  Position? myPositon;
  @override
  build(context) async {
  ...
  Future<void> _showEnableLocationPopup(BuildContext context,
      {required String title, required String description, required Future<bool> Function() positiveCallback}) async {
