...
class SignUpSelectUserTypeViewNew extends ConsumerStatefulWidget {
  const SignUpSelectUserTypeViewNew({Key? key, this.isBusinessAccount = false}) : super(key: key);
  final bool isBusinessAccount;

  @override
  ConsumerState<SignUpSelectUserTypeViewNew> createState() => _SignUpSelectUserTypeViewNewState();
}

class _SignUpSelectUserTypeViewNewState extends ConsumerState<SignUpSelectUserTypeViewNew> {
          ...
          children: [
            ...
            Container(
              ...
              child: ListView.separated(
                shrinkWrap: true,
                itemCount: widget.isBusinessAccount ? BusinessAccountType.values.length : TalentAccountType.values.length,
                ...
                itemBuilder: (context, index) {
                  if (widget.isBusinessAccount) {
                    return typeWidget(BusinessAccountType.values[index].displayName);
                  }
                  return typeWidget(TalentAccountType.values[index].displayName);
                },
            ...
            AnimatedContainer(
              ...
              height: signUpController.selectedIndustry.contains('Other') ? 12.h : 0,
              // scale:
              ...
              child: SingleChildScrollView(
                ...
                child: VWidgetsPrimaryTextFieldWithTitle(
                  ...
                  hintText: widget.isBusinessAccount ? 'Ex. Creative Agency' : "Ex. Voice Actor",
                ),
              ),
            ),
            addVerticalSpacing(20),
              ...
              child: VWidgetsPrimaryButton(
                onPressed: () async {
                  ...
                  await registerRepoInstance.updateAccountType(
                    ...
                    signUpController.isUserSpecifiedType ? inputController.text.trim() : signUpController.selectedIndustry.value,
                  );
    ...
    if (type != "\"Just a normal user\"") {
      ...
      return GestureDetector(
        onTap: () {
          setState(() {
            isSelected = true;
            signUpUserType = controller.isUserSpecifiedType ? inputController.text.trim() : type;
          });
        ...
        child: Padding(
          ...
          child: Container(
            ...
            child: Text(
              type,
              style: Theme.of(context).textTheme.displayMedium!.copyWith(fontWeight: fontWeight, color: VmodelColors.hintColor.withOpacity(opacity)),
      ...
      return Padding(
        ...
        child: Container(
          ...
          child: Text(
            type,
            style: Theme.of(context).textTheme.displayMedium!.copyWith(fontWeight: FontWeight.w500, color: VmodelColors.hintColor.withOpacity(opacity)),
