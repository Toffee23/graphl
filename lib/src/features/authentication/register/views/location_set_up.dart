...
class SignUpLocationViews extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SignUpLocationViews> createState() => _SignUpLocationViewsState();
}
...
class _SignUpLocationViewsState extends ConsumerState<SignUpLocationViews> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: VWidgetsAppBar(appbarTitle: "", leadingIcon: VWidgetsBackButton()
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                'What city are you in?',
                style: context.textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.w600, fontSize: 14.sp),
              ),
              addVerticalSpacing(8),
              AuthTextField(
                // label: "",
                      ...
                      onPressed: () async {
                        ...
                        if (widget.isLocationUpdate) {
                          ...
                          if (mounted) {
                            ...
                            await ref.read(appUserProvider.notifier).updateUserLocation(lat: lat, lon: long, locationName: locController.text.trim());
                            // VLoader.changeLoadingState(false);
                            isShowButtonLoading.value = false;
                            goBack(context);
                          }
                          ...
                          if (mounted) {
                            context.push("/signup-display-name");
                            /*navigateToRoute(
