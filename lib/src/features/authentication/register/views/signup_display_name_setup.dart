...
class SignUpDisplayNameSetup extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SignUpDisplayNameSetup> createState() => _SignUpDisplayNameSetupState();
}

class _SignUpDisplayNameSetupState extends ConsumerState<SignUpDisplayNameSetup> {
          ...
          child: SingleChildScrollView(
            child: Column(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              VWidgetsTextFieldNormal(
                ...
                // maxLines: 1,
                hintText: isBusinessAccount ? 'Eg: Fashion House' : 'Bella Perfect',
                  ...
                  return Padding(
                    ...
                    child: VWidgetsPrimaryButton(
                      ...
                      onPressed: () async {
                        ...
                        await ref.read(appUserProvider.notifier).updateProfile(displayName: textController.text.trim());
                        // VLoader.changeLoadingState(false);
                        isShowButtonLoading.value = false;

                        if (context.mounted) {
                          context.push("/signup-bio-setup");
