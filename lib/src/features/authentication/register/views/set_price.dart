  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: GestureDetector(
        ...
        child: Padding(
          padding: const EdgeInsets.only(left: 25.0, right: 25, top: 20, bottom: 25),
          child: Column(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.center, children: [
            addVerticalSpacing(150),
            Text(
              'How much will you charge per hour? ',
              style: VModelTypography1.promptTextStyle.copyWith(fontWeight: FontWeight.w600, fontSize: 14.sp),
            ),
            ...
            Row(
              ...
              children: [
                Text(
                  "£",
                  style: VModelTypography1.promptTextStyle.copyWith(fontWeight: FontWeight.w600, fontSize: 35.sp, color: VModelTypography1.promptTextStyle.color!.withOpacity(0.5)),
                ),
                ...
                SizedBox(
                  ...
                  child: VWidgetsTextFieldWithoutTitle(
                    ...
                    validator: (value) => VValidatorsMixin.isValidServicePrice(value, field: 'Price'),
                    onSaved: (p0) {},
                    onChanged: (p0) {},
                    onFieldSubmitted: (p0) {},
                  ),
            ...
            Text(
              ...
              style: VModelTypography1.promptTextStyle.copyWith(fontWeight: FontWeight.w300, fontSize: 10.sp),
            ),
            const Spacer(),
            vWidgetsInitialButton(
              () async {
                ...
                await registerRepoInstance.updatePrice(globalUsername!, double.parse(notifierR.priceController.text), signUpUserType);
