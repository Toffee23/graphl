...
class SignUpSelectUserTypeView extends StatefulWidget {
  ...
  @override
  State<SignUpSelectUserTypeView> createState() => _SignUpSelectUserTypeViewState();
}

class _SignUpSelectUserTypeViewState extends State<SignUpSelectUserTypeView> {
  bool isSelected = false;
  final List userTypes = const ["Model, Creator, Virtual Model", "", "Creative Director, Producer", "", "Business", "", "Booker", "", "Pet Models", ""];
