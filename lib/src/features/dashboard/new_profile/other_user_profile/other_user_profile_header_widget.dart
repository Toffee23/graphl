        ...
        child: Wrap(
          ...
          children: [
            ...
            VWidgetsProfileSubInfoDetails(
              stars: "${user?.reviewStats?.rating}",
              userRatingCount: "${user?.reviewStats?.noOfReviews}",
              address: !user!.meta!.location!
                  ? null
            ...
            VWidgetsOtherUserProfileButtons(
              ...
              requestPressed: () {
                context.push('/createRequestPage', extra: user);
              },
              ...
              messagesOnPressed: () async {
                ...
                if (context.mounted) {
                  ...
                  String? profileThumbnailUrl = user.profilePictureUrl;
                  context.push(
          ...
          return AlignTransition(
            ...
            child: ScaleTransition(
              ...
              child: FadeTransition(
                ...
                child: PopupHeadshot(
                  url: url,
                  thumbnailUrl: thumbnailUrl == null ? url : thumbnailUrl,
                ),
              ),
            ),
          );
  ...
  Future<void> _removeConnectionConfirmation(BuildContext context) {
    ...
    return VBottomSheetComponent.customBottomSheet(
        ...
        child: Consumer(builder: (context, ref, child) {
          return VWidgetsConfirmationWithPictureBottomSheet(
            username: widget.username,
            showPill: false,
              ...
              VWidgetsBottomSheetTile(
                  onTap: () async {
                    ...
                    await ref.read(connectionProvider).deleteConnection(
                        int.parse(widget.connectionId!.toString().trim()));
                    ref.read(connectionProcessingProvider.notifier).state =
                        false;
                    // ref.refresh(profileProvider(widget.username));
                    // ref
                    //     .read(showRequestConnectionProvider.notifier)
