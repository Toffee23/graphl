...
class _VWidgetsOtherUserProfileFunctionalityState
  ...
  Widget build(BuildContext context) {
    ...
    final VAppUser user = userState.valueOrNull!;
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Switch.adaptive(
                                activeColor:
                                    UIConstants.switchActiveColor(context),
                                value: isPostNotificationOn,
                                onChanged: (value) {
                                  isPostNotificationOn = value;
                                  setState(() {});
                                  ref
                                      .read(profileProvider(user.username)
                                          .notifier)
                                      .toggleFollowingNotification(
                                        notifyOnService: false,
