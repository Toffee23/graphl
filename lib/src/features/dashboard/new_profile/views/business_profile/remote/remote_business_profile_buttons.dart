...
class VWidgetsOtherBusinessProfileButtons extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<VWidgetsOtherBusinessProfileButtons> createState() => _VWidgetsOtherBusinessProfileButtonsState();
}

class _VWidgetsOtherBusinessProfileButtonsState extends ConsumerState<VWidgetsOtherBusinessProfileButtons> {
...
//print(" widget.connectionStatus${ widget.connectionStatus}");
    return SafeArea(
      bottom: true,
      child: Wrap(
            ...
            children: [
              Flexible(
                child: VWidgetsPrimaryButton(
                  ...
                  buttonTitle: "Message",
                  enableButton: widget.connectionStatus == 'connection_request_accepted' ? true : false,
                      ...
                      : widget.connectionStatus == 'connection_request_accepted'
                          ...
                          : Expanded(
                              child: VWidgetsPrimaryButton(
                                ...
                                buttonTitle: widget.isFollowing ?? false ? 'Following' : "Connect",
                                enableButton: true,
                              ),
                            ),
              addHorizontalSpacing(6),
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: enableSocial ? widget.socialAccountsOnPressed : null,
                  child: enableSocial
                      ? const RenderSvg(
                          svgHeight: 22,
