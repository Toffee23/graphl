...
class MyBusinessProfileState extends ConsumerState<MyBusinessProfile> {
  ...
  DefaultTabController galleryView(BuildContext context, String username, String? profilePictureUrl, String? thumbnailUrl, AsyncValue<List<GalleryModel>> galleries) {
          ...
          return Column(
            ...
            children: <Widget>[
              Material(
                color: Colors.white,
                child: TabBar(
                  labelStyle: Theme.of(context).textTheme.displayMedium?.copyWith(fontWeight: FontWeight.w600),
                  labelColor: VmodelColors.primaryColor,
                  unselectedLabelColor: VmodelColors.unselectedText,
                  unselectedLabelStyle: Theme.of(context).textTheme.displayMedium?.copyWith(fontWeight: FontWeight.w500),
