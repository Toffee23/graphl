...
class UserGalleryOnlyModel {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'postSets': postSets==null?[]:postSets!.map((x) => x.toMap()).toList(),
    };
  }
  ...
  factory UserGalleryOnlyModel.fromMap(Map<String, dynamic> map) {
    return UserGalleryOnlyModel(
      ...
      galleryType: AlbumType.values.byName(map['galleryType'].toString()),
      postSets: map['postSets'].map<AlbumPostSetModel>((item)=>AlbumPostSetModel.fromMap(
          {
            'id': item['id'],
            'albumId':map['id'],
            'album':item['album'],
