...
class UserJobsRepository {
  ...
  Future<Either<CustomException, Map<String, dynamic>>> getUserJobs(String username) async {
    try {
  ...
  Future<Either<CustomException, Map<String, dynamic>>> deleteJob({required int jobId}) async {
    try {
...
query popularJobs(\$dataCount: Int!) {
  ...
  Future<Either<CustomException, Map<String, dynamic>>> userHasJob({required String username}) async {
    try {
      final result = await vBaseServiceInstance.mutationQuery(mutationDocument: '''
