        ...
        Row(
          children: [
            if (user != null && user!.isBusinessAccount!)
              if (user!.meta!.specialty!)
                Text(
                  user?.label != null ? '${user?.label}' : '${user?.userType}',
                  style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                ...
                child: GestureDetector(
                  ...
                  child: Text(
                    ...
                    style: Theme.of(context).textTheme.displayMedium?.copyWith(
                          ...
                          color: Colors
                              .grey, //Theme.of(context).primaryColor.withOpacity(0.5),
                        ),
                  ),
                ),
              ),
            ...
            showModalBottomSheet(
                ...
                builder: (context) {
                  return TextBottomSheet(
                    title: 'Bio', //'About ${user?.displayName}',
                    content: '${user?.bio}',
                    isBio: true,
                  );
                });
