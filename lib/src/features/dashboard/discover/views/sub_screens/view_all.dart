        ...
        children: [
          ...
          Expanded(
            child: GridView.builder(
                ...
                gridDelegate:
                    const SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2, crossAxisSpacing: 25, mainAxisSpacing: 29, childAspectRatio: 0.7),
                ...
                itemBuilder: (BuildContext context, int index) {
                  return DiscoverSubItemViewAll(
                    onTap: () {
                      ...
                      // );
                      _navigateToUserProfile(dataList[index].username, isViewAll: true);
                    },
                    onLongPress: () {
                      showAnimatedDialog(
                        context: context,
