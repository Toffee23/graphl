                ...
                children: [
                  Row(
                    children: [
                      ...
                      //   ),
                      // ),
                      ProfilePicture(displayName: '$userNickName', url: '$userImageThumbnail', headshotThumbnail: '$userImageThumbnail', size: 44, showBorder: false, profileRing: profileRing),
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            userType ?? userName!,
                            style: Theme.of(context).textTheme.displayMedium!.copyWith(fontWeight: FontWeight.w500, color: Theme.of(context).primaryColor.withOpacity(0.3), fontSize: 10.sp),
                          ),
                        ],
                      ),
                    ],
                  ),
                  if (shouldHaveRemoveButton == true) IconButton(onPressed: onPressedRemove, icon: const RenderSvg(svgPath: VIcons.cancelTile))
                ],
              ),
            ),
          ),
