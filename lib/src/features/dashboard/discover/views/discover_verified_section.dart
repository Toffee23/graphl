...
class DiscoverVerifiedSection extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _DiscoverVerifiedSectionState();
}

class _DiscoverVerifiedSectionState extends ConsumerState<DiscoverVerifiedSection> {
  @override
          ...
          children: [
            ...
            ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return DiscoverFollowUserTile(displayName: vfUser.displayName, username: vfUser.username, title: vfUser.username, subTitle: vfUser.labelOrUserType, blueTickVerified: vfUser.blueTickVerified, isVerified: vfUser.isVerified, isFollow: vfUser.blueTickVerified || vfUser.isBusinessAccount!, profileImage: vfUser.profilePictureUrl, profileImageThumbnail: vfUser.thumbnailUrl, profileRing: vfUser.profileRing);
              },
            ),
            SizedBox(height: 10),
            Padding(
