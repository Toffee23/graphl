...
class HashTagSearchRepository {
  ...
  Future<Either<CustomException, Map<String, dynamic>>> hashTagSearch({int? pageCount, int? pageNumber, String? search}) async {
    try {
...
''', payload: {
  ...
  Future<Either<CustomException, Map<String, dynamic>>> recentHashTags({int? pageCount, int? pageNumber, String? search}) async {
    try {
      final result = await vBaseServiceInstance.getQuery(queryDocument: '''
...
''', payload: {});
  ...
  Future<Either<CustomException, Map<String, dynamic>>> popularHashTags({int? pageCount, int? pageNumber, String? search}) async {
    try {
      final result = await vBaseServiceInstance.getQuery(queryDocument: '''
