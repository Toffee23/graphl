    ...
    try {
      ...
      return response.fold((left) {
        ...
        if (pageNumber != null && pageNumber > 1) {
          ...
          state =
              AsyncValue.data([ ...parsedList, ...(state.valueOrNull ?? [])]);
        }
        return parsedList;
      });
    } catch (e) {
