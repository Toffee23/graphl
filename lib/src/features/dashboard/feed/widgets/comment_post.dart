...
class _CommentPostState extends State<CommentPost> {
  ...
  Widget build(BuildContext context) {
    ...
    final postUsernameStyle = Theme.of(context).textTheme.displayMedium!.copyWith(
      ...
      children: [
                ...
                child: GestureDetector(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Flexible( 
                        child: Visibility(
                          visible: widget.postLocation == null || widget.postLocation!.isEmpty,
                          replacement: Column(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: Theme.of(context).textTheme.displaySmall!.copyWith(fontSize: 9.sp, color: Theme.of(context).primaryColor
                                    // .withOpacity(0.5),
                                    ),
                              ),
                            ],
          ...
          builder: (BuildContext context, WidgetRef ref, Widget? child) {
            ...
            return Stack(
              ...
              children: [
                RawGestureDetector(
                  gestures: {
                    SerialTapGestureRecognizer: GestureRecognizerFactoryWithHandlers<SerialTapGestureRecognizer>(() => SerialTapGestureRecognizer(), (SerialTapGestureRecognizer instance) {
                      instance.onSerialTapDown = (SerialTapDownDetails details) async {
        ...
        Padding(
          ...
          child: Row(
            ...
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              Flexible(child: Consumer(builder: (BuildContext context, WidgetRef ref, Widget? child) {
                return FeedFirstRowIcons(
                  ...
                  saved: () async {
                    if (saveBool) {
                      final result = await ref.read(mainFeedProvider.notifier).onSavePost(postId: widget.postId, currentValue: saveBool);
              ...
              if (widget.imageList.length == 1) Expanded(child: addHorizontalSpacing(4)),
