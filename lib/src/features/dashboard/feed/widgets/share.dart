...
class ShareWidget extends StatelessWidget {
  ...
  const ShareWidget({required this.shareLabel, required this.shareTitle, required this.shareImage, required this.shareURL, this.isWebPicture = false, Key? key}) : super(key: key);
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: isWebPicture ? CachedNetworkImageProvider(shareImage!) : Image.asset(shareImage!).image,
                  fit: BoxFit.cover,
                ),
              ),
            ),
...
class ShareOption extends StatelessWidget {
  const ShareOption({Key? key, required this.title, required this.iconPath, this.height, this.width, this.onTap}) : super(key: key);
