            ...
            if (numberOfShares > 0)
              Padding(
                ...
                child: Text(
                  ...
                  style: Theme.of(context).textTheme.displayMedium!.copyWith(fontSize: 12, fontWeight: FontWeight.w500, color: VmodelColors.primaryColor),
                ),
              ),
          ],
        ),
                ...
                if (notification == true)
                  Padding(
                    ...
                    child: notiBadge.Badge(
                      ...
                      badgeContent: Text(
                        '3',
                        style: Theme.of(context).textTheme.displaySmall!.copyWith(color: VmodelColors.white),
                      ),
                      child: SvgPicture.asset(
                        secondIcon,
                        width: 230,
