        ...
        headerSliverBuilder: (context, value) {
          return [
            SliverAppBar(
              ...
              flexibleSpace: Padding(
                ...
                child: Column(
                  children: [
                        ...
                        Flexible(
                          child: Padding(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(wordSpacing: 5, fontFamily: "AvenirNext,Medium", fontSize: 15, color: VmodelColors.buttonColor),
                            ),
                          ),
                        ),
                      ],
                    ...
                    Padding(
                      padding: EdgeInsets.only(right: 0, left: 20.sp, top: 7.sp, bottom: 0),
                      child: Column(
                        children: [
                          Padding(
                            padding: const EdgeInsets.only(
                            ...
                            child: Row(
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsets.only(right: 7.sp, left: 7.sp, top: 7.sp, bottom: 7.sp),
                                  child: Text(
                                    "4.9",
                                    style: TextStyle(fontFamily: "AvenirNext,Medium", fontSize: 15, color: VmodelColors.mainColor),
                                  ),
                                ),
                              ],
                            ),
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.only(right: 10, left: 7, top: 7, bottom: 7),
                                child: Text(
                                  "Los Angeles, USA",
                                  style: TextStyle(fontFamily: "AvenirNext,Medium", fontSize: 15, color: VmodelColors.mainColor),
                                ),
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(right: 11, left: 10, top: 7, bottom: 0),
                                  child: Text(
                    ...
                    ElevatedButton(
                        ...
                        child: Center(
                          child: Text(
                            "Book Now",
                            style: TextStyle(fontFamily: "AvenirNext,Medium", fontSize: 15, color: VmodelColors.white),
              ...
              bottom: TabBar(padding: const EdgeInsets.all(0), controller: tabBarController, tabs: [
                PolaroidRow(
