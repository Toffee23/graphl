  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetX<OnboardingController>(builder: (controller) {
        // controller.phone("");
        return controller.phone.string == '' || controller.phone.string.length < 4
            ? Column(
                          ...
                          child: Center(
                            child: Form(
                              ...
                              child: IntlPhoneField(
                                ...
                                onChanged: (phone) {
                                  Get.find<OnboardingController>().phoneController.text = phone.completeNumber;
                                },
                                validator: (v) => VValidatorsMixin.isPhoneValid(v!.number),
                              ),
                            ),
                          ),
                        ),
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Center(
                        ...
                        style: TextStyle(color: VmodelColors.mainColor, fontSize: 16),
                      )),
                      const SizedBox(
                        height: 10,
                      ),
                      Center(
                        ...
                        style: TextStyle(color: VmodelColors.mainColor, fontSize: 12),
