          ...
          Padding(
            ...
            child: Column(
              children: [
                Center(
                    child: Text(
                  selectedIndustry == 'Business' ? 'Please enter your business name' : 'Please enter your name',
                ...
                Container(
                  ...
                  child: Form(
                      ...
                      child: VWidgetsSignUpTextField(
                        ...
                        hintText: selectedIndustry == 'Business' ? 'Ex: Matt’s Kitchen' : 'Ex: Jane Cooper',
                        validator: VValidatorsMixin.isNameValid,
                        controller: Get.find<OnboardingController>().nameController,
                      )),
                ),
              ],
            ),
