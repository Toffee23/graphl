                      ...
                      children: [
                        Center(
                          child: Text(
                            ...
                            style: Theme.of(context).textTheme.displayMedium!.copyWith(fontWeight: FontWeight.w600, color: Theme.of(context).primaryColor, fontSize: 13.sp),
                          ),
                        ),
                            ...
                            children: [
                              Container(
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(fontWeight: FontWeight.w600, color: VmodelColors.mainColor, fontSize: 16),
                                ),
                              ),
                              ...
                              VWidgetsSignUpTextField(
                                ...
                                onSaved: (p0) {
                                  Get.find<OnboardingController>().streetAddress(p0);
                                },
                          ...
                          child: Column(
                            children: [
                              Container(
                                ...
                                child: Text(
                                  'City',
                                  style: TextStyle(color: VmodelColors.mainColor, fontSize: 16, fontWeight: FontWeight.w600),
                                ),
                              ),
                              addVerticalSpacing(5),
                              VWidgetsSignUpTextField(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    VWidgetsSignUpTextField(
                                      ...
                                      hintText: 'Ex: RM95AG',
                                      onSaved: (p0) {
                                        Get.find<OnboardingController>().postCode(p0);
                                      },
                                      validator: (v) => VValidatorsMixin.isNotEmpty(
                                        v,
                                        field: 'Postcode',
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    VWidgetsSignUpTextField(
                                      ...
                                      hintText: 'Ex: London',
                                      onSaved: (p0) {
                                        Get.find<OnboardingController>().state(p0);
                                      },
                                      validator: (v) => VValidatorsMixin.isNotEmpty(
                                        v,
                                        field: 'State',
