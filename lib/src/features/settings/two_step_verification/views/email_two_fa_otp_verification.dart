...
class EmailTwoFaOtpVerificationScreen extends ConsumerStatefulWidget {
  static const title = 'Email authentication';
  static const route = '/email_two_fa_otp_verification';
  EmailTwoFaOtpVerificationScreen({Key? key}) : super(key: key);

  @override
  ConsumerState<EmailTwoFaOtpVerificationScreen> createState() =>
      _EmailTwoFaOtpVerificationScreenState();
}

class _EmailTwoFaOtpVerificationScreenState
    extends ConsumerState<EmailTwoFaOtpVerificationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: const VWidgetsAppBar(
          ...
          appbarTitle: EmailTwoFaOtpVerificationScreen.title,
        ),
        body: Padding(
