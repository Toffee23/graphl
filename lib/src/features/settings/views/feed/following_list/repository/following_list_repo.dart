...
class FollowingListRepository {
  ...
  Future<Either<CustomException, List<dynamic>>> getFollowedUsers({int? pageCount, int? pageNumber, String? search}) async {
    try {
    ...
    try {
      ...
      return result.fold(
        ...
        (right) {
          ...
          //print(right);
          final unblockUserResultData = right?['unfollowUser'] as Map<String, dynamic>?;
