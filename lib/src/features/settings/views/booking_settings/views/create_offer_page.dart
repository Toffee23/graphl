...
class _AddNewServicesHomepageState extends ConsumerState<CreateOfferPage> {
  ...
  WorkLocation _serviceType = WorkLocation.myLocation;
            ...
            children: [
                ...
                children: [
                  ...
                  Expanded(
                    child: VWidgetsDropDownTextField(
                      ...
                      hintText: '',
                      isDisabled: _serviceType == WorkLocation.myLocation,
              ...
              VWidgetsPrimaryButton(
                ...
                onPressed: () async {
                  ...
                  // if (selectedCategoryList.isNotEmpty) {
                  //   Map<String, dynamic> response = await ref.read(servicePackagesProvider(null).notifier).createOffer(
