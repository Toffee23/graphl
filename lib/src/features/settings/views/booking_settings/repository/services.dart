...
abstract class ServiceRepository {
  ...
  Future<Either<CustomException, List<dynamic>>> userService(String? username, int? serviceId);
}
...
//   }
  ...
  @override
  Future<Either<CustomException, List<dynamic>>> userServices(String? username) async {
    try {
  ...
  @override
  Future<Either<CustomException, List<dynamic>>> userService(String? username, int? serviceId) async {
    try {
      final result = await vBaseServiceInstance.getQuery(queryDocument: '''
...
class UserServiceRepository {
  ...
  Future<Either<CustomException, Map<String, dynamic>>> userService(String? username, int? serviceId) async {
    try {
      final result = await vBaseServiceInstance.getQuery(queryDocument: '''
query userService(
  #\$username: String!,
  ...
  Future<Either<CustomException, Map<String, dynamic>>> likeService(int serviceId) async {
    //print(serviceId);
    try {
  ...
  Future<Either<CustomException, Map<String, dynamic>>> saveService(int serviceId) async {
    //print(serviceId);
    try {
      final result = await vBaseServiceInstance.mutationQuery(mutationDocument: '''
