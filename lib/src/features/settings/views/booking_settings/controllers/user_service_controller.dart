...
final userServicePackagesProvider = AsyncNotifierProvider.autoDispose.family<UserServicePackageController, ServicePackageModel, UserServiceModel?>(() => UserServicePackageController());

class UserServicePackageController extends AutoDisposeFamilyAsyncNotifier<ServicePackageModel, UserServiceModel?> {
  ...
  Future<bool> likeService(String packageId) async {
    ...
    makeRequest.fold((onLeft) {
      ...
      state = AsyncValue.data(currentData!.copyWith(
        likes: currentData.userLiked ? currentData.likes! - 1 : currentData.likes! + 1,
  ...
  Future<bool> saveService(String packageId) async {
    ...
    return makeRequest.fold((onLeft) {
      ...
      try {
        ...
        if (currentData != null)
          state = AsyncValue.data(currentData.copyWith(
            saves: currentData.userSaved ? currentData.saves! - 1 : currentData.saves! + 1,
