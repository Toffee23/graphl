...
import '../../../../../vmodel.dart';
import '../../../../live_classes/controllers/live_class_selected_banners_provider.dart';
...
class ServiceImageListView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ServiceImageListView> createState() => _ServiceImageListViewState();
}
            ...
            for (int index = 0; index < widget.fileImages.length; index += 1) ...[
              if (widget.fileImages[index].isFile)
                SelectedServiceImage(
                  ...
                  onPressRemove: () {
                    if (widget.jobs == true) {
                      ref.read(liveClassImagesProvider.notifier).removeImage(index);
                    } else {
