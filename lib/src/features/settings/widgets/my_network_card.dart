          ...
          children: [
                  ...
                  Column(
                    ...
                    children: [
                      VerifiedUsernameWidget(
                        ...
                        textStyle: Theme.of(context).textTheme.displayMedium!.copyWith(fontWeight: FontWeight.w600, fontSize: 12.sp),
                      ),
                      // Text(
                      //   userNickName!,
                      ...
                      Text(
                        subTitle,
                        style: Theme.of(context).textTheme.displayMedium!.copyWith(fontWeight: FontWeight.w500, color: Theme.of(context).primaryColor.withOpacity(0.6), fontSize: 10.sp),
                      ),
                    ],
                  ),
                ],
            ...
            Row(
              children: [
                ...
                GestureDetector(onTap: onPressedRemove, child: const RenderSvg(svgPath: VIcons.remove)),
              ],
            )
            // OutlinedButton(
