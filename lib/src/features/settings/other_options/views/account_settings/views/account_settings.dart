...
class AccountSettings extends StatelessWidget {
  ...
  _buildRedirectingListTile(
    ...
    return InkWell(
      ...
      child: ListTile(
        title: Text(
          title,
          style: VModelTypography1.sheetCenterCTA.copyWith(fontWeight: FontWeight.w600, letterSpacing: 1),
        ),
        subtitle: Text(
          subtitle,
          style: VModelTypography1.sheetCenterCTA.copyWith(letterSpacing: 1, fontSize: 14, color: const Color(0xff696464)),
        ),
        trailing: const Icon(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.zero, side: BorderSide(color: Colors.grey[200]!)),
          toolbarHeight: 100,
          backgroundColor: VmodelColors.background,
          leading: const VWidgetsBackButton(),
          title: Text(
            'Settings',
            style: VModelTypography1.pageTitleTextStyle.copyWith(fontSize: 16, fontWeight: FontWeight.w600),
          )),
      backgroundColor: VmodelColors.background,
      body: Container(
