                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          GestureDetector(
                              onTap: () async {
                                ...
                                Future.delayed(const Duration(seconds: 2), () => referCodeCopied.value = false);
                              },
                      ...
                      Text('More options', style: Theme.of(context).textTheme.titleLarge!.copyWith(fontWeight: FontWeight.bold)),
                          ...
                          Expanded(
                            child: VWidgetsPrimaryButton(
                              onPressed: () {
                                ...
                                context.go('/invite_contacts');
                              },
                              buttonTitle: "Invite contacts",
                              enableButton: true,
                              buttonColor: Theme.of(context).buttonTheme.colorScheme?.background,
                            ),
                        ...
                        child: ListView(
                          ...
                          children: [
                            RewardsInfoCard(
                              ...
                              subtitleText: 'Unlock Rewards by Sharing VModel with Friends',
                              onCopyPressed: () => copyTextToClipboard(VMString.vmodelDiscordPioneersUrl),
                            ...
                            RewardsInfoCard(
                              ...
                              subtitleText: 'Expand your network and earnings with email invitations!',
                              // 'Get £10 for every new friend who completes their first job!',
                            ),
                            RewardsInfoCard(
                              leadingSvgAsset: RenderSvg(
                              ...
                              subtitleText: 'Effortless Networking and Earnings with QR Code Invitations',
                              // 'Get £10 for every new friend who completes their first job!',
                            ),
                          ],
                        ),
