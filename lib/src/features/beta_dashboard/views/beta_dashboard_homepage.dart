...
class BetaDashboardHomepage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    _navigateTo({required String title, required String url}) {
      Navigator.of(context).push(MaterialPageRoute(builder: (builder) => BetaDashBoardWeb(title: title, url: url)));
    }
//    Suggest a feature
...
// App Documentation
    ...
    List betaDashboardItems = [
      ...
      VWidgetsSettingsSubMenuTileWidget(
          ...
          onTap: () {
            _navigateTo(title: 'Updates documentation', url: 'https://vmodel.app/');
          }),
      VWidgetsSettingsSubMenuTileWidget(
          ...
          Expanded(
            child: Padding(
              ...
              child: ListView.separated(
                  padding: EdgeInsets.zero, itemBuilder: ((context, index) => betaDashboardItems[index]), separatorBuilder: (context, index) => const Divider(), itemCount: betaDashboardItems.length),
            ),
          ),
        ],
      ),
