...
class HottestCouponList extends ConsumerStatefulWidget {
  const HottestCouponList({super.key});
  static const routeName = 'allCouponsSimple';

  @override
  ConsumerState<HottestCouponList> createState() => _HottestCouponListState();
}

class _HottestCouponListState extends ConsumerState<HottestCouponList> {
  ...
  Widget build(BuildContext context) {
    ...
    return hottestCouponsSimple.when(data: (data) {
      if (data.isNotEmpty)
        return Scaffold(
