...
class ApplicantsSortBottomSheet extends ConsumerStatefulWidget {
  const ApplicantsSortBottomSheet({
    Key? key,
  ...
  @override
  ConsumerState<ApplicantsSortBottomSheet> createState() =>
      _ApplicantsFilterBottomSheetState();
}

class _ApplicantsFilterBottomSheetState
    extends ConsumerState<ApplicantsSortBottomSheet> {
  @override
