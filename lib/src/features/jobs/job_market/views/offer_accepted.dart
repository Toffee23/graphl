          ...
          children: [
            ...
            Align(
              child: Text(
                ...
                style: Theme.of(context).textTheme.displayMedium?.copyWith(fontWeight: FontWeight.w500, fontSize: 14, color: VmodelColors.white),
            ...
            VWidgetsPrimaryButton(
                ...
                buttonTitle: "Okay",
                buttonTitleTextStyle: Theme.of(context).textTheme.displayMedium?.copyWith(fontWeight: FontWeight.w600, fontSize: 14, color: VmodelColors.primaryColor),
                enableButton: true,
                buttonColor: VmodelColors.white,
                butttonWidth: MediaQuery.of(context).size.width / 3),
          ],
        ),
      ),
    );
