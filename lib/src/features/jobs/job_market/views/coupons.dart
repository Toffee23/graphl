            ...
            child: SmartRefresher(
              ...
              child: CustomScrollView(
                ...
                slivers: [
                  ...
                  if (ref.watch(allCouponsSearchProvider).isEmptyOrNull) CouponsEndWidget(),
                ],
              ),
            ),
          ),
        );
      return CustomErrorDialogWithScaffold(onTryAgain: () => ref.refresh(allCouponsProvider), title: "Coupons");
    }, loading: () {
