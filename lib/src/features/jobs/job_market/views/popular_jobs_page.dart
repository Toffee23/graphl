...
import '../../../../shared/shimmer/popular_jobs_page_shimmer.dart';
...
class PopularJobsCategoryPage extends ConsumerStatefulWidget {
  // final List<JobPostModel> job;
  static const routeName = 'popularJobsCategoryPage';
  final String? title;
  const PopularJobsCategoryPage({super.key, this.title = "Popular"});

  @override
  ConsumerState<PopularJobsCategoryPage> createState() => _PopularJobsCategoryState();
}

class _PopularJobsCategoryState extends ConsumerState<PopularJobsCategoryPage> {
  ...
  Widget build(BuildContext context) {
    final categoryName = ref.watch(selectedPopularJobCategoryProvider);
    final searchProviderState = ref.watch(allJobsSearchTermProvider);
    final jobsState = ref.watch(popularJobsProvider);
