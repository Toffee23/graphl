        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              addVerticalSpacing(8),
              iconText(assetIcon: VIcons.jobDetailDate, text: '15 Dec 2022 - 18 Dec 2022'),
              addVerticalSpacing(8),
              iconText(assetIcon: VIcons.jobDetailUsageType, text: 'Commercial'),
              addVerticalSpacing(8),
              iconText(assetIcon: VIcons.jobDetailMap, text: '200 Leighman Close, Brentford BL32AA'),
              addVerticalSpacing(8),
              ...
              Text(
                ...
                style: Theme.of(context).textTheme.displayMedium!.copyWith(fontWeight: FontWeight.w400, color: VmodelColors.primaryColor),
              ),
              addVerticalSpacing(16),
              Text(
                ...
                style: Theme.of(context).textTheme.displaySmall!.copyWith(fontWeight: FontWeight.w500, color: VmodelColors.primaryColor),
              ),
              addVerticalSpacing(16),
              const Divider(),
