...
class BusinessMyJobsPageMarketplace extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<BusinessMyJobsPageMarketplace> createState() => _BusinessMyJobsPageMarketplaceState();
}

class _BusinessMyJobsPageMarketplaceState extends ConsumerState<BusinessMyJobsPageMarketplace> {
  ...
  void initState() {
    ...
    _ca = List.generate(VConstants.tempCategories.length, (index) {
      return DiscoverItemObject(name: VConstants.tempCategories[index], image: mockDiscoverCategoryAssets[index], userType: '', label: '', username: '');
    });
  }
  ...
  void _onCategoryChanged(DiscoverCategory currentList) {
    ...
    _ca = List.generate(subList.length, (index) {
      return DiscoverItemObject(name: subList[index], image: subAssets[index], userType: '', label: '', username: '');
    });
  ...
  Widget build(BuildContext context) {
    ...
    final isCurrentUser = ref.read(appUserProvider.notifier).isCurrentUser(currentUser?.username);
                                          ...
                                          children: [
                                            IconButton(
                                              onPressed: () {
                                                ...
                                                String? _title = null;
                                                context.push('${Routes.localServices.split("/:").first}/$_title');
                                                //[go_route]
                                                // context.pushNamed(
                      ...
                      children: [
                        Expanded(
                          ...
                          child: SearchTextFieldWidget(
                            ...
                            hintText: value == 'jobs' ? "Eg: Model Wanted" : "Eg: Last minute stylists needed ASAP",
