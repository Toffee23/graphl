...
class JobApplicationsModel {
  ...
  JobApplicationsModel.fromJson(Map<String, dynamic> json) {
    ...
    applicant = json['applicant'] != null ? VAppUser.fromMinimalMap(json['applicant']) : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['coverMessage'] = this.coverMessage;
    if (this.job != null) {
...
class Applicant {
  ...
  Applicant({this.id, this.username, this.displayName, this.profilePictureUrl, this.thumbnailUrl, this.email, this.label, this.isVerified, this.bio});
