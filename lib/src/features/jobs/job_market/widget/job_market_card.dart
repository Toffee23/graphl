          ...
          child: Column(
            ...
            children: [
                    ...
                    children: <Widget>[
                      ...
                      Align(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.all(10.0),
                          child: Text(
                            "Tilly’s Bakery Services",
                            style: Theme.of(context).textTheme.displayMedium?.copyWith(color: VmodelColors.white, fontWeight: FontWeight.w600, fontSize: 14),
                          ),
                        ),
                      ),
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            "2 Days ago",
                            style: Theme.of(context).textTheme.displayMedium?.copyWith(color: VmodelColors.white, fontWeight: FontWeight.w500, fontSize: 12),
                          ),
                        ),
                      ),
                    ],
              ...
              Text(
                ...
                style: Theme.of(context).textTheme.displayMedium?.copyWith(color: VmodelColors.primaryColor, fontWeight: FontWeight.w500, fontSize: 11.sp, wordSpacing: 5),
              ),
        ...
        children: [
          ...
          Flexible(
            child: Text(
              ...
              style: Theme.of(context).textTheme.displayMedium!.copyWith(fontWeight: FontWeight.w500, color: Theme.of(context).primaryColor, fontSize: 11.sp),
            ),
          ),
        ],
      ),
