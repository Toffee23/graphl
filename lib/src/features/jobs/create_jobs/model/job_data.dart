...
class JobDataModel {
  ...
  factory JobDataModel.fromMap(Map<String, dynamic> map) {
    return JobDataModel(
      ...
      minAge: map['minAge'] as int,
      maxAge: map['maxAge'] as int,
      height: Map<String, dynamic>.from((map['height'] as Map<String, dynamic>)),
      size: map['size'] != null ? ModelSize.modelSizeByApiValue(map['size'] as String) : null,
      ethnicity: map['ethnicity'] != null ? Ethnicity.ethnicityByApiValue(map['ethnicity'] as String) : null,
      complexion: map['complexion'] != null ? map['complexion'] as String : null,
      category: map['category'] != null ? ServiceType.fromJson(map['category']) : null,
  ...
  factory JobDataModel.fromJson(String source) => JobDataModel.fromMap(json.decode(source) as Map<String, dynamic>);
