...
class JobApplication {
  ...
  factory JobApplication.fromMap(Map<String, dynamic> map) {
    return JobApplication(
      id: map['id'] as String,
      coverMessage: map['coverMessage'],
      proposedPrice: map['proposedPrice'] as double,
      applicant: VAppUser.fromMinimalMap(map['applicant'] as Map<String, dynamic>),
  ...
  bool operator ==(covariant JobApplication other) {
    ...
    return other.id == id && other.proposedPrice == proposedPrice && other.applicant == applicant && other.accepted == accepted && other.rejected == rejected;
  }

  @override
  int get hashCode {
    return id.hashCode ^ proposedPrice.hashCode ^ applicant.hashCode ^ accepted.hashCode ^ rejected.hashCode;
  }
}
