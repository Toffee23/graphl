...
class _BookingJobDetailPageState extends ConsumerState<BookingJobDetailPage> {
  ...
  void initState() {
    ...
    // for (var item in widget.jobId.jobDelivery) {
  ...
  Widget build(BuildContext context) {
    ...
    final similarJobs = ref.watch(similarJobsProvider(int.parse(widget.jobId)));
        ...
        trailingIcon: [
          VWidgetsTextButton(
            ...
            onPressed: () {
              ...
              // navigateToRoute(
              //     context, BookingsProgressPage(bookingId: widget.booking.id!));
            },
          ),
                  ...
                  children: [
                    GestureDetector(
                      onTap: () {
                        ...
                        String? _userName = value.creator?.username;
                        context.push(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            ...
                            // if (isCurrentUser) navigateToRoute(
                            //       context,
                ...
                children: [
                  if (value.category != null)
                    _jobPersonRow(context,
                        field: 'Category', value: '${value.category!.name}'),
                  _jobPersonRow(context,
                  ...
                  if (value.jobType.toLowerCase() != "remote")
                    _jobPersonRow(context,
                        field: 'Address', value: value.jobLocation.toString()),
                  _datesRow(context,
            ...
            return Container(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    Center(
                      child: Text(
                          "Selecting ' initiates your order. Please proceed only if you've reviewed all necessary details.",
                          textAlign: TextAlign.center,
                          style:
                    ...
                    _optionItem(context, title: "Start booking",
                      ...
                      // // //print('[yyyBB] $map');
                      // navigateToRoute(mainContext,
                      //     BookingsProgressPage(bookingId: widget.booking.id!));
                    }),
                    const Divider(thickness: 0.5),
