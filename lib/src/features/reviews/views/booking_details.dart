              ...
              [
                ...
                Padding(
                  ...
                  child: Text(
                    ...
                    style: Theme.of(context).textTheme.displayMedium!.copyWith(fontSize: 17, fontWeight: FontWeight.w600, color: VmodelColors.primaryColor),
                  ),
                ),
                addVerticalSpacing(25),
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        "Mon, 12 Oct, 2023\n13:00",
                        style: Theme.of(context).textTheme.displayMedium!.copyWith(fontSize: 14, fontWeight: FontWeight.w500, color: VmodelColors.primaryColor),
                      ),
                      Container(
                        width: 1,
                        height: 45,
                  ...
                  onTap: () {
                    showAnimatedDialog(
                      ...
                      child: VWidgetsConfirmationPopUp(
                        ...
                        popupDescription: "Are you sure you want to cancel this booking?",
                        onPressedYes: () async {
    ...
    return Padding(
      ...
      child: Row(
        children: [
          Text(
            title,
            style: Theme.of(context).textTheme.displayMedium!.copyWith(fontSize: 14, fontWeight: FontWeight.w500, color: VmodelColors.text3),
          ),
